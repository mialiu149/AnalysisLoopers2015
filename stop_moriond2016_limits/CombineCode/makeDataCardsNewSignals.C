...
const int bgsize = 5;
TString sample_type[bgsize] = {"TTbar2l","TTbar1l", "WJets", "SingleT", "TTV"};
...
double rnd(double d);
void makeDataCardsAllBins(int version, TString signaltype, TString signalname, bool overrightdatawithBG=true, bool overrightdatawithBGplusSIG=false);
void makeDataCards(int version, int bin, TString signaltype, TString signalname, bool overrightdatawithBG=false, bool overrightdatawithBGplusSIG=false);
void makeDataCardsAll(TString signaltype, TString signalname, bool overrightdatawithBG=false, bool overrightdatawithBGplusSIG=false);
void makeDataCardsReallyAll();
...
void makeDataCardsReallyAll(){
  makeDataCardsAll("T2tt","Signal_T2tt_850_100",true,false);
  makeDataCardsAll("T2tt","Signal_T2tt_650_325",true,false);
  makeDataCardsAll("T2tt","Signal_T2tt_500_325",true,false);
  makeDataCardsAll("T2tt","Signal_T2tt_425_325",true,false);
  makeDataCardsAll("T2tb","Signal_T2tb_700_250_100",true,false);
  makeDataCardsAll("T2tb","Signal_T2tb_700_400_100",true,false);
  makeDataCardsAll("T2tb","Signal_T2tb_700_550_100",true,false);
  makeDataCardsAll("T2bw","Signal_T2bw_700_250_100",true,false);
  makeDataCardsAll("T2bw","Signal_T2bw_700_400_100",true,false);
  makeDataCardsAll("T2bw","Signal_T2bw_700_550_100",true,false);
  makeDataCardsAll("T2bw","Signal_T2bw_600_187p5_50",true,false);
  makeDataCardsAll("T2bw","Signal_T2bw_600_325_50",true,false);
  makeDataCardsAll("T2bw","Signal_T2bw_600_462p5_50",true,false);

}

void makeDataCardsAll(TString signaltype, TString signalname, bool overrightdatawithBG, bool overrightdatawithBGplusSIG){
  for(int version = 1; version <=17; ++version){
    ...
    if(version==15) bin =  5;
    if(version==16) bin =  9;
    if(version==17) bin = 11;
    for(unsigned int b= 1; b<=bin;++b)
      makeDataCards(version,b,signaltype,signalname,overrightdatawithBG,overrightdatawithBGplusSIG);
  }
}


void makeDataCards(int version, int bin, TString signaltype, TString signalname, bool overrightdatawithBG, bool overrightdatawithBGplusSIG){
  ...
  string versionstring = "v" + std::to_string(version);
  inputdir = "inputfiles/" + versionstring + "/";
  if(loadData){
  ...
  signal = load(bin,inputdir,signalname.Data(),true,signalname.Data());
  ...
  *fLogStream << endl << "------------" << endl;
  ...
  logname = "datacards/newsignal/" +versionstring + "/" + signalname + "_" + binstring + ".txt";
...
void makeDataCardsAllBins(TString signaltype, TString signalname, bool overrightdatawithBG, bool overrightdatawithBGplusSIG){
  ...
  for(unsigned int i = 1; i<=maxsignal; ++i){
    int version = 0;
    makeDataCards(version,i,signaltype,signalname,overrightdatawithBG,overrightdatawithBGplusSIG);
  }
