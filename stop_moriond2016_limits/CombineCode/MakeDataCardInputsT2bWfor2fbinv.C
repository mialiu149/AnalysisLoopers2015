...
int ScanChain( TChain* chain, bool fast = true, int nEvents = -1, string skimFilePrefix = "test") {
  ...
  if(version== 1){ nbins =  7; blow = 0.5; bup =  7.5; storeh = true; }
  if(version== 2){ nbins =  5; blow = 0.5; bup =  5.5; storeh = true; }
  if(version== 3){ nbins =  4; blow = 0.5; bup =  4.5; storeh = true; }
  if(version== 4){ nbins =  4; blow = 0.5; bup =  4.5; storeh = true; }
  if(version== 5){ nbins =  3; blow = 0.5; bup =  3.5; storeh = true; }
  if(version== 6){ nbins =  4; blow = 0.5; bup =  4.5; storeh = true; }
  if(version== 7){ nbins =  5; blow = 0.5; bup =  5.5; storeh = true; }
  if(version== 8){ nbins =  5; blow = 0.5; bup =  5.5; storeh = true; }
  if(version== 9){ nbins =  5; blow = 0.5; bup =  5.5; storeh = true; }
  if(version==10){ nbins =  4; blow = 0.5; bup =  4.5; storeh = true; }
  if(version==11){ nbins =  4; blow = 0.5; bup =  4.5; storeh = true; }
  ...
  while ( (currentFile = (TFile*)fileIter.Next()) ) {
	...
	if(ak4pfjets_CSV()[nj]>0.890) {++NGBJets; }
      ...
      if(version==1){
	if(bpt<=100&&!mlb&&!mt2w) mybin = 1;
	if(bpt<=100&&!mlb&& mt2w) mybin = 2;
	if(bpt<=100&& mlb       ) mybin = 3;
	if(bpt> 100      &&!mt2w) mybin = 4;
	if(bpt> 100&&!mlb&& mt2w) mybin = 5;
	if(bpt> 100&& mlb&& mt2w) {
	...
	if(!mt2w) {
	  ...
	  if(!mlb) mybin = 3;
	    ...
	    if(met>350) mybin = 5; else mybin = 4;
	  }
	}
      }
      if(version==3){
   	if(!mt2w) mybin = 1;
   	if(bpt<=100&& mt2w) mybin = 2;
	if(bpt> 100&& mt2w){
	  if(met>400) mybin = 4; else mybin = 3;
	}
      }
      if(version==4){
   	if(mlb) {
	  if(met>375) mybin = 2; else mybin = 1;
	}
	else {
	  if(bpt<=100) mybin=3;
	  else mybin = 4;
	...
	if(bpt<=100) mybin=1;
	  ...
	  if(met>400) mybin = 3; else mybin =2;
	}
      }
      if(version==6){
	if(!mlb) {
	  if(met>400) mybin = 2; else mybin =1;
	}
	else {
	...
	if(!mt2w) {
	  ...
	  if(met>450) mybin = 5; else if(met>350) mybin = 4; else mybin =3;
	}  
      }
      if(version==8){
	if(bpt<=150&&!mlb&&!mt2w) mybin = 1;
	if(bpt<=150&&!mlb&& mt2w) mybin = 2;
	if(bpt<=150&& mlb       ) mybin = 3;
	if(bpt> 150&& mlb&& mt2w) mybin = 5;
	else if(bpt>150) mybin = 4;
      }
      if(version==9){
   	if(!mt2w) {
	  if(met>325) mybin = 2; else mybin =1;
	  ...
	  if(bpt<=150) mybin = 3;
	    ...
	    if(met>375) mybin = 5; else mybin =4;
	  }
	}
      }
      if(version==10){
  ...
  for(unsigned int b = 0; b<2; ++b){
    ...
    if(version== 1) filename = "inputfiles/v1/new"+samplename+".root";
    if(version== 2) filename = "inputfiles/v2/new"+samplename+".root";
    if(version== 3) filename = "inputfiles/v3/new"+samplename+".root";
    if(version== 4) filename = "inputfiles/v4/new"+samplename+".root";
    if(version== 5) filename = "inputfiles/v5/new"+samplename+".root";
    if(version== 6) filename = "inputfiles/v6/new"+samplename+".root";
    if(version== 7) filename = "inputfiles/v7/new"+samplename+".root";
    if(version== 8) filename = "inputfiles/v8/new"+samplename+".root";
    if(version== 9) filename = "inputfiles/v9/new"+samplename+".root";
    if(version==10) filename = "inputfiles/v10/new"+samplename+".root";
    if(version==11) filename = "inputfiles/v11/new"+samplename+".root";
    if(version==12) filename = "inputfiles/v12/new"+samplename+".root";
    if(version==13) filename = "inputfiles/v13/new"+samplename+".root";
    if(version==14) filename = "inputfiles/v14/new"+samplename+".root";
    if(version==15) filename = "inputfiles/v15/new"+samplename+".root";
    if(version==16) filename = "inputfiles/v16/new"+samplename+".root";
    if(version==17) filename = "inputfiles/v17/new"+samplename+".root";
