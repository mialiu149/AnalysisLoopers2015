{
  ...
  //gROOT->ProcessLine(".L MakeDataCardInputsT2bW.C+");
  gROOT->ProcessLine(".L MakeDataCardInputsT2bWfor2fbinv.C+");
  ...
  */
  ...
  //myhelper = babylocation+"DYJetsToLL_m10To50_amcnlo_pythia8_25ns.root";  ch[3]->Add(myhelper.c_str());
  //myhelper = babylocation+"DYJetsToLL_m50_amcnlo_pythia8_25ns.root";      ch[3]->Add(myhelper.c_str());
  ...
  for(int i = 0; i<chainsize; ++i){
    //cout << "bla " << endl;
    if(i==4) continue;//deleted DY sample
    TChain *mych = ch[i];
