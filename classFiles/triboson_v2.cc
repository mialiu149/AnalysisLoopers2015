#include "triboson_v2.h"
triboson_v2 cms3_triboson_v2;

void triboson_v2::Init(TTree *tree) {
	lep_p4_branch = 0;
...
void triboson_v2::GetEntry(unsigned int idx) 
...
void triboson_v2::LoadAllBranches() 
	// load all branches
{
	if (run_branch != 0) run();
	...
	const unsigned long long &triboson_v2::evt()
	{
		if (not evt_isLoaded) {
			if (evt_branch != 0) {
	...
	const bool &	triboson_v2::evt_passgoodrunlist()
	{
	...
	const float &triboson_v2::evt_scale1fb()
	{
	...
	const float &triboson_v2::evt_xsec()
	{
	...
	const float &triboson_v2::evt_kfactor()
	{
	...
	const float &triboson_v2::evt_filter()
	{
	...
	const int &triboson_v2::evt_nEvts()
	{
	...
	const vector<TString> &triboson_v2::evt_dataset()
	{
	...
	const float &triboson_v2::puWeight()
	{
	...
	const int &triboson_v2::nTrueInt()
	{
	...
	const float &triboson_v2::gen_ht()
	{
	...
	const int &triboson_v2::nBJetTight()
	{
	...
	const int &triboson_v2::nBJetMedium()
	{
	...
	const int &triboson_v2::nBJetLoose()
	{
	...
	const int &triboson_v2::nBJetTight_up()
	{
	...
	const int &triboson_v2::nBJetMedium_up()
	{
	...
	const int &triboson_v2::nBJetLoose_up()
	{
	...
	const int &triboson_v2::nBJetTight_dn()
	{
	...
	const int &triboson_v2::nBJetMedium_dn()
	{
	...
	const int &triboson_v2::nBJetLoose_dn()
	{
	...
	const int &triboson_v2::nJet200MuFrac50DphiMet()
	{
	...
	const int &triboson_v2::nMuons10()
	{
	...
	const int &triboson_v2::nBadMuons20()
	{
	...
	const int &triboson_v2::nElectrons10()
	{
	...
	const int &triboson_v2::nGammas20()
	{
	...
	const float &triboson_v2::met_pt()
	{
	...
	const float &triboson_v2::met_phi()
	{
	...
	const float &triboson_v2::met_calo_pt()
	{
	...
	const float &triboson_v2::met_calo_phi()
	{
	...
	const float &triboson_v2::met_miniaod_pt()
	{
	...
	const float &triboson_v2::met_miniaod_phi()
	{
	...
	const float &triboson_v2::met_muegclean_pt()
	{
	...
	const float &triboson_v2::met_muegclean_phi()
	{
	...
	const float &triboson_v2::met_rawPt()
	{
	...
	const float &triboson_v2::met_rawPhi()
	{
	...
	const float &triboson_v2::met_genPt()
	{
	...
	const float &triboson_v2::met_genPhi()
	{
	...
	const float &triboson_v2::sumet_raw()
	{
	...
	const int &triboson_v2::Flag_ecalLaserCorrFilter()
	{
	...
	const int &triboson_v2::Flag_hcalLaserEventFilter()
	{
	...
	const int &triboson_v2::Flag_trackingFailureFilter()
	{
	...
	const int &triboson_v2::Flag_CSCTightHaloFilter()
	{
	...
	const int &triboson_v2::Flag_HBHENoiseFilter()
	{
	...
	const int &triboson_v2::Flag_HBHEIsoNoiseFilter()
	{
	...
	const int &triboson_v2::Flag_CSCTightHalo2015Filter()
	{
	...
	const int &triboson_v2::Flag_EcalDeadCellTriggerPrimitiveFilter()
	{
	...
	const int &triboson_v2::Flag_goodVertices()
	{
	...
	const int &triboson_v2::Flag_eeBadScFilter()
	{
	...
	const int &triboson_v2::Flag_globalTightHalo2016()
	{
	...
	const int &triboson_v2::Flag_badMuonFilter()
	{
	...
	const int &triboson_v2::Flag_badChargedCandidateFilter()
	{
	...
	const int &triboson_v2::Flag_badMuonFilterv2()
	{
	...
	const int &triboson_v2::Flag_badChargedCandidateFilterv2()
	{
	...
	const int &triboson_v2::Flag_badMuons()
	{
	...
	const int &triboson_v2::Flag_duplicateMuons()
	{
	...
	const int &triboson_v2::Flag_noBadMuons()
	{
	...
	const int &triboson_v2::HLT_singleEl()
	{
	...
	const int &triboson_v2::HLT_singleMu()
	{
	...
	const int &triboson_v2::HLT_singleMu_noiso()
	{
	...
	const int &triboson_v2::HLT_DoubleEl_noiso()
	{
	...
	const int &triboson_v2::HLT_DoubleEl()
	{
	...
	const int &triboson_v2::HLT_DoubleEl_DZ()
	{
	...
	const int &triboson_v2::HLT_DoubleEl_DZ_2()
	{
	...
	const int &triboson_v2::HLT_MuEG()
	{
	...
	const int &triboson_v2::HLT_MuEG_2()
	{
	...
	const int &triboson_v2::HLT_MuEG_noiso()
	{
	...
	const int &triboson_v2::HLT_MuEG_noiso_2()
	{
	...
	const int &triboson_v2::HLT_Mu8_EG17()
	{
	...
	const int &triboson_v2::HLT_Mu8_EG23()
	{
	...
	const int &triboson_v2::HLT_Mu8_EG23_DZ()
	{
	...
	const int &triboson_v2::HLT_Mu12_EG23_DZ()
	{
	...
	const int &triboson_v2::HLT_Mu17_EG12()
	{
	...
	const int &triboson_v2::HLT_Mu23_EG8()
	{
	...
	const int &triboson_v2::HLT_Mu23_EG8_DZ()
	{
	...
	const int &triboson_v2::HLT_Mu23_EG12()
	{
	...
	const int &triboson_v2::HLT_Mu23_EG12_DZ()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_noiso()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_noiso_27_8()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_noiso_30_11()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_noiso_40_11()
	{
	...
	const int &triboson_v2::HLT_DoubleMu()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_tk()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_dbltk()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_nonDZ()
	{
	...
	const int &triboson_v2::HLT_DoubleMu_tk_nonDZ()
	{
	...
	const int &triboson_v2::HLT_Photon22_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon30_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon36_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon50_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon75_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon90_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon120_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon165_R9Id90_HE10_IsoM()
	{
	...
	const int &triboson_v2::HLT_Photon165_HE10()
	{
	...
	const int &triboson_v2::HLT_CaloJet500_NoJetID()
	{
	...
	const int &triboson_v2::HLT_ECALHT800_NoJetID()
	{
	...
	const bool &	triboson_v2::HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton()
	{
	...
	const bool &	triboson_v2::HLT_Photon165_HE10_matchedtophoton()
	{
	...
	const float &triboson_v2::dilmass()
	{
	...
	const float &triboson_v2::matched_neutralemf()
	{
	...
	const float &triboson_v2::matched_emf()
	{
	...
	const int &triboson_v2::nveto_leptons()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::lep_p4()
	{
	...
	const vector<float> &triboson_v2::lep_pt()
	{
	...
	const vector<float> &triboson_v2::lep_eta()
	{
	...
	const vector<float> &triboson_v2::lep_phi()
	{
	...
	const vector<float> &triboson_v2::lep_mass()
	{
	...
	const vector<int> &triboson_v2::lep_charge()
	{
	...
	const vector<bool> &triboson_v2::lep_3ch_agree()
	{
	...
	const vector<int> &triboson_v2::lep_isFromW()
	{
	...
	const vector<double> &triboson_v2::lep_ptRatio()
	{
	...
	const vector<double> &triboson_v2::lep_ptRel()
	{
	...
	const vector<double> &triboson_v2::lep_relIso03()
	{
	...
	const vector<double> &triboson_v2::lep_relIso03DB()
	{
	...
	const vector<double> &triboson_v2::lep_relIso03EA()
	{
	...
	const vector<double> &triboson_v2::lep_relIso03EAv2()
	{
	...
	const vector<double> &triboson_v2::lep_relIso04DB()
	{
	...
	const vector<double> &triboson_v2::lep_relIso04EA()
	{
	...
	const vector<double> &triboson_v2::lep_relIso04EAv2()
	{
	...
	const vector<double> &triboson_v2::lep_miniRelIsoCMS3_EA()
	{
	...
	const vector<double> &triboson_v2::lep_miniRelIsoCMS3_EAv2()
	{
	...
	const vector<double> &triboson_v2::lep_miniRelIsoCMS3_DB()
	{
	...
	const vector<int> &triboson_v2::lep_pdgId()
	{
	...
	const vector<float> &triboson_v2::lep_dxy()
	{
	...
	const vector<float> &triboson_v2::lep_ip3d()
	{
	...
	const vector<float> &triboson_v2::lep_ip3derr()
	{
	...
	const vector<float> &triboson_v2::lep_etaSC()
	{
	...
	const vector<float> &triboson_v2::lep_dz()
	{
	...
	const vector<int> &triboson_v2::lep_tightId()
	{
	...
	const vector<int> &triboson_v2::lep_mcMatchId()
	{
	...
	const vector<int> &triboson_v2::lep_lostHits()
	{
	...
	const vector<int> &triboson_v2::lep_convVeto()
	{
	...
	const vector<int> &triboson_v2::lep_tightCharge()
	{
	...
	const vector<float> &triboson_v2::lep_MVA()
	{
	...
	const vector<float> &triboson_v2::lep_validfraction()
	{
	...
	const vector<float> &triboson_v2::lep_pterr()
	{
	...
	const vector<float> &triboson_v2::lep_sta_pterrOpt()
	{
	...
	const vector<float> &triboson_v2::lep_glb_pterrOpt()
	{
	...
	const vector<float> &triboson_v2::lep_x2ondof()
	{
	...
	const vector<float> &triboson_v2::lep_sta_x2ondof()
	{
	...
	const vector<float> &triboson_v2::lep_glb_x2ondof()
	{
	...
	const int &triboson_v2::nisoTrack_5gev()
	{
	...
	const int &triboson_v2::nisoTrack_mt2()
	{
	...
	const int &triboson_v2::nisoTrack_PFLep5_woverlaps()
	{
	...
	const int &triboson_v2::nisoTrack_PFHad10_woverlaps()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::gamma_p4()
	{
	...
	const vector<float> &triboson_v2::gamma_pt()
	{
	...
	const vector<float> &triboson_v2::gamma_eta()
	{
	...
	const vector<float> &triboson_v2::gamma_phi()
	{
	...
	const vector<float> &triboson_v2::gamma_mass()
	{
	...
	const vector<int> &triboson_v2::gamma_mcMatchId()
	{
	...
	const vector<float> &triboson_v2::gamma_genPt()
	{
	...
	const vector<float> &triboson_v2::gamma_genIso()
	{
	...
	const vector<float> &triboson_v2::gamma_chHadIso()
	{
	...
	const vector<float> &triboson_v2::gamma_neuHadIso()
	{
	...
	const vector<float> &triboson_v2::gamma_phIso()
	{
	...
	const vector<float> &triboson_v2::gamma_sigmaIetaIeta()
	{
	...
	const vector<float> &triboson_v2::gamma_r9()
	{
	...
	const vector<float> &triboson_v2::gamma_hOverE()
	{
	...
	const vector<float> &triboson_v2::gamma_hOverE_online()
	{
	...
	const vector<int> &triboson_v2::gamma_idCutBased()
	{
	...
	const vector<float> &triboson_v2::gamma_ecpfclusiso()
	{
	...
	const vector<float> &triboson_v2::gamma_hcpfclusiso()
	{
	...
	const vector<float> &triboson_v2::gamma_hollowtkiso03()
	{
	...
	const vector<int> &triboson_v2::gamma_genIsPromptFinalState()
	{
	...
	const vector<float> &triboson_v2::gamma_drMinParton()
	{
	...
	const int &triboson_v2::ngenPart()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::genPart_p4()
	{
	...
	const vector<float> &triboson_v2::genPart_pt()
	{
	...
	const vector<float> &triboson_v2::genPart_eta()
	{
	...
	const vector<float> &triboson_v2::genPart_phi()
	{
	...
	const vector<float> &triboson_v2::genPart_mass()
	{
	...
	const vector<int> &triboson_v2::genPart_pdgId()
	{
	...
	const vector<int> &triboson_v2::genPart_status()
	{
	...
	const vector<float> &triboson_v2::genPart_charge()
	{
	...
	const vector<int> &triboson_v2::genPart_motherId()
	{
	...
	const vector<int> &triboson_v2::genPart_grandmaId()
	{
	...
	const vector<bool> &triboson_v2::genPart_isp6status3()
	{
	...
	const vector<float> &triboson_v2::genLep_pt()
	{
	...
	const vector<float> &triboson_v2::genLep_eta()
	{
	...
	const vector<float> &triboson_v2::genLep_phi()
	{
	...
	const vector<float> &triboson_v2::genLep_mass()
	{
	...
	const vector<int> &triboson_v2::genLep_pdgId()
	{
	...
	const vector<int> &triboson_v2::genLep_status()
	{
	...
	const vector<float> &triboson_v2::genLep_charge()
	{
	...
	const vector<int> &triboson_v2::genLep_sourceId()
	{
	...
	const vector<bool> &triboson_v2::genLep_isp6status3()
	{
	...
	const vector<float> &triboson_v2::genTau_pt()
	{
	...
	const vector<float> &triboson_v2::genTau_eta()
	{
	...
	const vector<float> &triboson_v2::genTau_phi()
	{
	...
	const vector<float> &triboson_v2::genTau_mass()
	{
	...
	const vector<int> &triboson_v2::genTau_pdgId()
	{
	...
	const vector<int> &triboson_v2::genTau_status()
	{
	...
	const vector<float> &triboson_v2::genTau_charge()
	{
	...
	const vector<int> &triboson_v2::genTau_sourceId()
	{
	...
	const int &triboson_v2::ngenLepFromTau()
	{
	...
	const vector<float> &triboson_v2::genLepFromTau_pt()
	{
	...
	const vector<float> &triboson_v2::genLepFromTau_eta()
	{
	...
	const vector<float> &triboson_v2::genLepFromTau_phi()
	{
	...
	const vector<float> &triboson_v2::genLepFromTau_mass()
	{
	...
	const vector<int> &triboson_v2::genLepFromTau_pdgId()
	{
	...
	const vector<int> &triboson_v2::genLepFromTau_status()
	{
	...
	const vector<float> &triboson_v2::genLepFromTau_charge()
	{
	...
	const vector<int> &triboson_v2::genLepFromTau_sourceId()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::jets_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::removed_jets_p4()
	{
	...
	const vector<float> &triboson_v2::removed_jets_csv()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::jets_medb_p4()
	{
	...
	const int &triboson_v2::njets_up()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::jets_up_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::jets_medb_up_p4()
	{
	...
	const vector<float> &triboson_v2::jets_csv()
	{
	...
	const vector<float> &triboson_v2::jets_up_csv()
	{
	...
	const int &triboson_v2::njets_dn()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::jets_dn_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::jets_medb_dn_p4()
	{
	...
	const vector<float> &triboson_v2::jets_dn_csv()
	{
	...
	const vector<float> &triboson_v2::jets_muf()
	{
	...
	const vector<int> &triboson_v2::jets_mcFlavour()
	{
	...
	const vector<int> &triboson_v2::jets_mcHadronFlav()
	{
	...
	const int &triboson_v2::nhighPtPFcands()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &triboson_v2::highPtPFcands_p4()
	{
	...
	const vector<float> &triboson_v2::highPtPFcands_dz()
	{
	...
	const vector<int> &triboson_v2::highPtPFcands_pdgId()
	{
	...
	const float &triboson_v2::metsig_unofficial()
	{
	...
	const float &triboson_v2::metsig_unofficial_up()
	{
	...
	const float &triboson_v2::metsig_unofficial_dn()
	{
	...
	const float &triboson_v2::mt_lep1()
	{
	...
	const float &triboson_v2::mt2_up()
	{
	...
	const float &triboson_v2::mt2_dn()
	{
	...
	const float &triboson_v2::mt2b_up()
	{
	...
	const float &triboson_v2::mt2b_dn()
	{
	...
	const float &triboson_v2::mt2_genmet()
	{
	...
	const float &triboson_v2::mt2b_genmet()
	{
	...
	const float &triboson_v2::mjj_mindphi()
	{
	...
	const float &triboson_v2::mbb_csv()
	{
	...
	const float &triboson_v2::mbb_bpt()
	{
	...
	const float &triboson_v2::dphi_jj()
	{
	...
	const float &triboson_v2::dphi_ll()
	{
	...
	const float &triboson_v2::sum_mlb()
	{
	...
	const float &triboson_v2::deta_jj()
	{
	...
	const float &triboson_v2::dphi_metj1()
	{
	...
	const float &triboson_v2::dphi_metj2()
	{
	...
	const float &triboson_v2::dphi_genmetj1()
	{
	...
	const float &triboson_v2::dphi_genmetj2()
	{
	...
	const float &triboson_v2::mjj_mindphi_up()
	{
	...
	const float &triboson_v2::mjj_up()
	{
	...
	const float &triboson_v2::mbb_csv_up()
	{
	...
	const float &triboson_v2::mbb_bpt_up()
	{
	...
	const float &triboson_v2::dphi_jj_up()
	{
	...
	const float &triboson_v2::dphi_ll_up()
	{
	...
	const float &triboson_v2::sum_mlb_up()
	{
	...
	const float &triboson_v2::deta_jj_up()
	{
	...
	const float &triboson_v2::dR_jj_up()
	{
	...
	const float &triboson_v2::dphi_metj1_up()
	{
	...
	const float &triboson_v2::dphi_metj2_up()
	{
	...
	const float &triboson_v2::mjj_mindphi_dn()
	{
	...
	const float &triboson_v2::mjj_dn()
	{
	...
	const float &triboson_v2::mbb_csv_dn()
	{
	...
	const float &triboson_v2::mbb_bpt_dn()
	{
	...
	const float &triboson_v2::dphi_jj_dn()
	{
	...
	const float &triboson_v2::dphi_ll_dn()
	{
	...
	const float &triboson_v2::sum_mlb_dn()
	{
	...
	const float &triboson_v2::deta_jj_dn()
	{
	...
	const float &triboson_v2::dR_jj_dn()
	{
	...
	const float &triboson_v2::dphi_metj1_dn()
	{
	...
	const float &triboson_v2::dphi_metj2_dn()
	{
	...
	const float &triboson_v2::weight_btagsf()
	{
	...
	const float &triboson_v2::weight_btagsf_heavy_UP()
	{
	...
	const float &triboson_v2::weight_btagsf_light_UP()
	{
	...
	const float &triboson_v2::weight_btagsf_heavy_DN()
	{
	...
	const float &triboson_v2::weight_btagsf_light_DN()
	{
	...
	const float &triboson_v2::chpfcands_0013_pt()
	{
	...
	const float &triboson_v2::chpfcands_1316_pt()
	{
	...
	const float &triboson_v2::chpfcands_1624_pt()
	{
	...
	const float &triboson_v2::chpfcands_2430_pt()
	{
	...
	const float &triboson_v2::chpfcands_30in_pt()
	{
	...
	const float &triboson_v2::phpfcands_0013_pt()
	{
	...
	const float &triboson_v2::phpfcands_1316_pt()
	{
	...
	const float &triboson_v2::phpfcands_1624_pt()
	{
	...
	const float &triboson_v2::phpfcands_2430_pt()
	{
	...
	const float &triboson_v2::phpfcands_30in_pt()
	{
	...
	const float &triboson_v2::nupfcands_0013_pt()
	{
	...
	const float &triboson_v2::nupfcands_1316_pt()
	{
	...
	const float &triboson_v2::nupfcands_1624_pt()
	{
	...
	const float &triboson_v2::nupfcands_2430_pt()
	{
	...
	const float &triboson_v2::nupfcands_30in_pt()
	{
	...
	const float &triboson_v2::chpfcands_0013_sumet()
	{
	...
	const float &triboson_v2::chpfcands_1316_sumet()
	{
	...
	const float &triboson_v2::chpfcands_1624_sumet()
	{
	...
	const float &triboson_v2::chpfcands_2430_sumet()
	{
	...
	const float &triboson_v2::chpfcands_30in_sumet()
	{
	...
	const float &triboson_v2::phpfcands_0013_sumet()
	{
	...
	const float &triboson_v2::phpfcands_1316_sumet()
	{
	...
	const float &triboson_v2::phpfcands_1624_sumet()
	{
	...
	const float &triboson_v2::phpfcands_2430_sumet()
	{
	...
	const float &triboson_v2::phpfcands_30in_sumet()
	{
	...
	const float &triboson_v2::nupfcands_0013_sumet()
	{
	...
	const float &triboson_v2::nupfcands_1316_sumet()
	{
	...
	const float &triboson_v2::nupfcands_1624_sumet()
	{
	...
	const float &triboson_v2::nupfcands_2430_sumet()
	{
	...
	const float &triboson_v2::nupfcands_30in_sumet()
	{
	...
	const float &triboson_v2::chpfcands_0013_phi()
	{
	...
	const float &triboson_v2::chpfcands_1316_phi()
	{
	...
	const float &triboson_v2::chpfcands_1624_phi()
	{
	...
	const float &triboson_v2::chpfcands_2430_phi()
	{
	...
	const float &triboson_v2::chpfcands_30in_phi()
	{
	...
	const float &triboson_v2::phpfcands_0013_phi()
	{
	...
	const float &triboson_v2::phpfcands_1316_phi()
	{
	...
	const float &triboson_v2::phpfcands_1624_phi()
	{
	...
	const float &triboson_v2::phpfcands_2430_phi()
	{
	...
	const float &triboson_v2::phpfcands_30in_phi()
	{
	...
	const float &triboson_v2::nupfcands_0013_phi()
	{
	...
	const float &triboson_v2::nupfcands_1316_phi()
	{
	...
	const float &triboson_v2::nupfcands_1624_phi()
	{
	...
	const float &triboson_v2::nupfcands_2430_phi()
	{
	...
	const float &triboson_v2::nupfcands_30in_phi()
	{
	...
	const float &triboson_v2::met_T1CHS_pt()
	{
	...
	const float &triboson_v2::met_T1CHS_phi()
	{
	...
	const float &triboson_v2::met_T1CHS_fromCORE_pt()
	{
	...
	const float &triboson_v2::met_T1CHS_fromCORE_phi()
	{
	...
	const float &triboson_v2::met_T1CHS_miniAOD_CORE_pt()
	{
	...
	const float &triboson_v2::met_T1CHS_miniAOD_CORE_phi()
	{
	...
	const float &triboson_v2::met_T1CHS_miniAOD_CORE_up_pt()
	{
	...
	const float &triboson_v2::met_T1CHS_miniAOD_CORE_up_phi()
	{
	...
	const float &triboson_v2::met_T1CHS_miniAOD_CORE_dn_pt()
	{
	...
	const float &triboson_v2::met_T1CHS_miniAOD_CORE_dn_phi()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &triboson_v2::decayedphoton_lep1_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &triboson_v2::decayedphoton_lep2_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &triboson_v2::decayedphoton_bosn_p4()
	{
	...
	const float &triboson_v2::decayedphoton_mt2()
	{
	...
	const int &triboson_v2::hyp_type()
	{
	...
	const int &triboson_v2::evt_type()
	{
	...
	const int &triboson_v2::mass_gluino()
	{
	...
	const int &triboson_v2::mass_LSP()
	{
	...
	const int &triboson_v2::mass_chi()
	{
	...
	const float &triboson_v2::isrboost()
	{
	...
	const int &triboson_v2::isr_njets()
	{
	...
	const float &triboson_v2::isr_weight()
	{
	...
	const float &triboson_v2::isr_unc()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepid()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepiso()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepip()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepreco()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepconv()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepid_FS()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepiso_FS()
	{
	...
	const vector<float> &triboson_v2::weightsf_lepip_FS()
	{
  ...
  void triboson_v2::progress( int nEventsTotal, int nEventsChain ){
    int period = 1000;
...
namespace triboson_v2_np {
	const int &run() { return cms3_triboson_v2.run(); }
	const int &lumi() { return cms3_triboson_v2.lumi(); }
	const unsigned long long &evt() { return cms3_triboson_v2.evt(); }
	const int &isData() { return cms3_triboson_v2.isData(); }
	const bool &evt_passgoodrunlist() { return cms3_triboson_v2.evt_passgoodrunlist(); }
	const float &evt_scale1fb() { return cms3_triboson_v2.evt_scale1fb(); }
	const float &evt_xsec() { return cms3_triboson_v2.evt_xsec(); }
	const float &evt_kfactor() { return cms3_triboson_v2.evt_kfactor(); }
	const float &evt_filter() { return cms3_triboson_v2.evt_filter(); }
	const int &evt_nEvts() { return cms3_triboson_v2.evt_nEvts(); }
	const vector<TString> &evt_dataset() { return cms3_triboson_v2.evt_dataset(); }
	const float &puWeight() { return cms3_triboson_v2.puWeight(); }
	const int &nVert() { return cms3_triboson_v2.nVert(); }
	const int &nTrueInt() { return cms3_triboson_v2.nTrueInt(); }
	const float &rho() { return cms3_triboson_v2.rho(); }
	const float &rho25() { return cms3_triboson_v2.rho25(); }
	const float &gen_ht() { return cms3_triboson_v2.gen_ht(); }
	const int &nBJetTight() { return cms3_triboson_v2.nBJetTight(); }
	const int &nBJetMedium() { return cms3_triboson_v2.nBJetMedium(); }
	const int &nBJetLoose() { return cms3_triboson_v2.nBJetLoose(); }
	const int &nBJetTight_up() { return cms3_triboson_v2.nBJetTight_up(); }
	const int &nBJetMedium_up() { return cms3_triboson_v2.nBJetMedium_up(); }
	const int &nBJetLoose_up() { return cms3_triboson_v2.nBJetLoose_up(); }
	const int &nBJetTight_dn() { return cms3_triboson_v2.nBJetTight_dn(); }
	const int &nBJetMedium_dn() { return cms3_triboson_v2.nBJetMedium_dn(); }
	const int &nBJetLoose_dn() { return cms3_triboson_v2.nBJetLoose_dn(); }
	const int &nJet200MuFrac50DphiMet() { return cms3_triboson_v2.nJet200MuFrac50DphiMet(); }
	const int &nMuons10() { return cms3_triboson_v2.nMuons10(); }
	const int &nBadMuons20() { return cms3_triboson_v2.nBadMuons20(); }
	const int &nElectrons10() { return cms3_triboson_v2.nElectrons10(); }
	const int &nGammas20() { return cms3_triboson_v2.nGammas20(); }
	const int &nTaus20() { return cms3_triboson_v2.nTaus20(); }
	const float &met_pt() { return cms3_triboson_v2.met_pt(); }
	const float &met_phi() { return cms3_triboson_v2.met_phi(); }
	const float &met_calo_pt() { return cms3_triboson_v2.met_calo_pt(); }
	const float &met_calo_phi() { return cms3_triboson_v2.met_calo_phi(); }
	const float &met_miniaod_pt() { return cms3_triboson_v2.met_miniaod_pt(); }
	const float &met_miniaod_phi() { return cms3_triboson_v2.met_miniaod_phi(); }
	const float &met_muegclean_pt() { return cms3_triboson_v2.met_muegclean_pt(); }
	const float &met_muegclean_phi() { return cms3_triboson_v2.met_muegclean_phi(); }
	const float &met_rawPt() { return cms3_triboson_v2.met_rawPt(); }
	const float &met_rawPhi() { return cms3_triboson_v2.met_rawPhi(); }
	const float &met_genPt() { return cms3_triboson_v2.met_genPt(); }
	const float &met_genPhi() { return cms3_triboson_v2.met_genPhi(); }
	const float &sumet_raw() { return cms3_triboson_v2.sumet_raw(); }
	const int &Flag_ecalLaserCorrFilter() { return cms3_triboson_v2.Flag_ecalLaserCorrFilter(); }
	const int &Flag_hcalLaserEventFilter() { return cms3_triboson_v2.Flag_hcalLaserEventFilter(); }
	const int &Flag_trackingFailureFilter() { return cms3_triboson_v2.Flag_trackingFailureFilter(); }
	const int &Flag_CSCTightHaloFilter() { return cms3_triboson_v2.Flag_CSCTightHaloFilter(); }
	const int &Flag_HBHENoiseFilter() { return cms3_triboson_v2.Flag_HBHENoiseFilter(); }
	const int &Flag_HBHEIsoNoiseFilter() { return cms3_triboson_v2.Flag_HBHEIsoNoiseFilter(); }
	const int &Flag_CSCTightHalo2015Filter() { return cms3_triboson_v2.Flag_CSCTightHalo2015Filter(); }
	const int &Flag_EcalDeadCellTriggerPrimitiveFilter() { return cms3_triboson_v2.Flag_EcalDeadCellTriggerPrimitiveFilter(); }
	const int &Flag_goodVertices() { return cms3_triboson_v2.Flag_goodVertices(); }
	const int &Flag_eeBadScFilter() { return cms3_triboson_v2.Flag_eeBadScFilter(); }
	const int &Flag_globalTightHalo2016() { return cms3_triboson_v2.Flag_globalTightHalo2016(); }
	const int &Flag_badMuonFilter() { return cms3_triboson_v2.Flag_badMuonFilter(); }
	const int &Flag_badChargedCandidateFilter() { return cms3_triboson_v2.Flag_badChargedCandidateFilter(); }
	const int &Flag_badMuonFilterv2() { return cms3_triboson_v2.Flag_badMuonFilterv2(); }
	const int &Flag_badChargedCandidateFilterv2() { return cms3_triboson_v2.Flag_badChargedCandidateFilterv2(); }
	const int &Flag_badMuons() { return cms3_triboson_v2.Flag_badMuons(); }
	const int &Flag_duplicateMuons() { return cms3_triboson_v2.Flag_duplicateMuons(); }
	const int &Flag_noBadMuons() { return cms3_triboson_v2.Flag_noBadMuons(); }
	const int &HLT_singleEl() { return cms3_triboson_v2.HLT_singleEl(); }
	const int &HLT_singleMu() { return cms3_triboson_v2.HLT_singleMu(); }
	const int &HLT_singleMu_noiso() { return cms3_triboson_v2.HLT_singleMu_noiso(); }
	const int &HLT_DoubleEl_noiso() { return cms3_triboson_v2.HLT_DoubleEl_noiso(); }
	const int &HLT_DoubleEl() { return cms3_triboson_v2.HLT_DoubleEl(); }
	const int &HLT_DoubleEl_DZ() { return cms3_triboson_v2.HLT_DoubleEl_DZ(); }
	const int &HLT_DoubleEl_DZ_2() { return cms3_triboson_v2.HLT_DoubleEl_DZ_2(); }
	const int &HLT_MuEG() { return cms3_triboson_v2.HLT_MuEG(); }
	const int &HLT_MuEG_2() { return cms3_triboson_v2.HLT_MuEG_2(); }
	const int &HLT_MuEG_noiso() { return cms3_triboson_v2.HLT_MuEG_noiso(); }
	const int &HLT_MuEG_noiso_2() { return cms3_triboson_v2.HLT_MuEG_noiso_2(); }
	const int &HLT_Mu8_EG17() { return cms3_triboson_v2.HLT_Mu8_EG17(); }
	const int &HLT_Mu8_EG23() { return cms3_triboson_v2.HLT_Mu8_EG23(); }
	const int &HLT_Mu8_EG23_DZ() { return cms3_triboson_v2.HLT_Mu8_EG23_DZ(); }
	const int &HLT_Mu12_EG23_DZ() { return cms3_triboson_v2.HLT_Mu12_EG23_DZ(); }
	const int &HLT_Mu17_EG12() { return cms3_triboson_v2.HLT_Mu17_EG12(); }
	const int &HLT_Mu23_EG8() { return cms3_triboson_v2.HLT_Mu23_EG8(); }
	const int &HLT_Mu23_EG8_DZ() { return cms3_triboson_v2.HLT_Mu23_EG8_DZ(); }
	const int &HLT_Mu23_EG12() { return cms3_triboson_v2.HLT_Mu23_EG12(); }
	const int &HLT_Mu23_EG12_DZ() { return cms3_triboson_v2.HLT_Mu23_EG12_DZ(); }
	const int &HLT_DoubleMu_noiso() { return cms3_triboson_v2.HLT_DoubleMu_noiso(); }
	const int &HLT_DoubleMu_noiso_27_8() { return cms3_triboson_v2.HLT_DoubleMu_noiso_27_8(); }
	const int &HLT_DoubleMu_noiso_30_11() { return cms3_triboson_v2.HLT_DoubleMu_noiso_30_11(); }
	const int &HLT_DoubleMu_noiso_40_11() { return cms3_triboson_v2.HLT_DoubleMu_noiso_40_11(); }
	const int &HLT_DoubleMu() { return cms3_triboson_v2.HLT_DoubleMu(); }
	const int &HLT_DoubleMu_tk() { return cms3_triboson_v2.HLT_DoubleMu_tk(); }
	const int &HLT_DoubleMu_dbltk() { return cms3_triboson_v2.HLT_DoubleMu_dbltk(); }
	const int &HLT_DoubleMu_nonDZ() { return cms3_triboson_v2.HLT_DoubleMu_nonDZ(); }
	const int &HLT_DoubleMu_tk_nonDZ() { return cms3_triboson_v2.HLT_DoubleMu_tk_nonDZ(); }
	const int &HLT_Photon22_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon22_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon30_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon30_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon36_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon36_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon50_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon50_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon75_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon75_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon90_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon90_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon120_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon120_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon165_R9Id90_HE10_IsoM() { return cms3_triboson_v2.HLT_Photon165_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon165_HE10() { return cms3_triboson_v2.HLT_Photon165_HE10(); }
	const int &HLT_CaloJet500_NoJetID() { return cms3_triboson_v2.HLT_CaloJet500_NoJetID(); }
	const int &HLT_ECALHT800_NoJetID() { return cms3_triboson_v2.HLT_ECALHT800_NoJetID(); }
	const bool &HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton() { return cms3_triboson_v2.HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton(); }
	const bool &HLT_Photon165_HE10_matchedtophoton() { return cms3_triboson_v2.HLT_Photon165_HE10_matchedtophoton(); }
	const float &dilmass() { return cms3_triboson_v2.dilmass(); }
	const float &dilpt() { return cms3_triboson_v2.dilpt(); }
	const float &dRll() { return cms3_triboson_v2.dRll(); }
	const float &matched_neutralemf() { return cms3_triboson_v2.matched_neutralemf(); }
	const float &matched_emf() { return cms3_triboson_v2.matched_emf(); }
	const bool &elveto() { return cms3_triboson_v2.elveto(); }
	const int &nlep() { return cms3_triboson_v2.nlep(); }
	const int &nveto_leptons() { return cms3_triboson_v2.nveto_leptons(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &lep_p4() { return cms3_triboson_v2.lep_p4(); }
	const vector<float> &lep_pt() { return cms3_triboson_v2.lep_pt(); }
	const vector<float> &lep_eta() { return cms3_triboson_v2.lep_eta(); }
	const vector<float> &lep_phi() { return cms3_triboson_v2.lep_phi(); }
	const vector<float> &lep_mass() { return cms3_triboson_v2.lep_mass(); }
	const vector<int> &lep_charge() { return cms3_triboson_v2.lep_charge(); }
	const vector<bool> &lep_3ch_agree() { return cms3_triboson_v2.lep_3ch_agree(); }
	const vector<int> &lep_isFromW() { return cms3_triboson_v2.lep_isFromW(); }
	const vector<double> &lep_ptRatio() { return cms3_triboson_v2.lep_ptRatio(); }
	const vector<double> &lep_ptRel() { return cms3_triboson_v2.lep_ptRel(); }
	const vector<double> &lep_relIso03() { return cms3_triboson_v2.lep_relIso03(); }
	const vector<double> &lep_relIso03DB() { return cms3_triboson_v2.lep_relIso03DB(); }
	const vector<double> &lep_relIso03EA() { return cms3_triboson_v2.lep_relIso03EA(); }
	const vector<double> &lep_relIso03EAv2() { return cms3_triboson_v2.lep_relIso03EAv2(); }
	const vector<double> &lep_relIso04DB() { return cms3_triboson_v2.lep_relIso04DB(); }
	const vector<double> &lep_relIso04EA() { return cms3_triboson_v2.lep_relIso04EA(); }
	const vector<double> &lep_relIso04EAv2() { return cms3_triboson_v2.lep_relIso04EAv2(); }
	const vector<double> &lep_miniRelIsoCMS3_EA() { return cms3_triboson_v2.lep_miniRelIsoCMS3_EA(); }
	const vector<double> &lep_miniRelIsoCMS3_EAv2() { return cms3_triboson_v2.lep_miniRelIsoCMS3_EAv2(); }
	const vector<double> &lep_miniRelIsoCMS3_DB() { return cms3_triboson_v2.lep_miniRelIsoCMS3_DB(); }
	const vector<int> &lep_pdgId() { return cms3_triboson_v2.lep_pdgId(); }
	const vector<float> &lep_dxy() { return cms3_triboson_v2.lep_dxy(); }
	const vector<float> &lep_ip3d() { return cms3_triboson_v2.lep_ip3d(); }
	const vector<float> &lep_ip3derr() { return cms3_triboson_v2.lep_ip3derr(); }
	const vector<float> &lep_etaSC() { return cms3_triboson_v2.lep_etaSC(); }
	const vector<float> &lep_dz() { return cms3_triboson_v2.lep_dz(); }
	const vector<int> &lep_tightId() { return cms3_triboson_v2.lep_tightId(); }
	const vector<int> &lep_mcMatchId() { return cms3_triboson_v2.lep_mcMatchId(); }
	const vector<int> &lep_lostHits() { return cms3_triboson_v2.lep_lostHits(); }
	const vector<int> &lep_convVeto() { return cms3_triboson_v2.lep_convVeto(); }
	const vector<int> &lep_tightCharge() { return cms3_triboson_v2.lep_tightCharge(); }
	const vector<float> &lep_MVA() { return cms3_triboson_v2.lep_MVA(); }
	const vector<float> &lep_validfraction() { return cms3_triboson_v2.lep_validfraction(); }
	const vector<float> &lep_pterr() { return cms3_triboson_v2.lep_pterr(); }
	const vector<float> &lep_sta_pterrOpt() { return cms3_triboson_v2.lep_sta_pterrOpt(); }
	const vector<float> &lep_glb_pterrOpt() { return cms3_triboson_v2.lep_glb_pterrOpt(); }
	const vector<float> &lep_x2ondof() { return cms3_triboson_v2.lep_x2ondof(); }
	const vector<float> &lep_sta_x2ondof() { return cms3_triboson_v2.lep_sta_x2ondof(); }
	const vector<float> &lep_glb_x2ondof() { return cms3_triboson_v2.lep_glb_x2ondof(); }
	const int &nisoTrack_5gev() { return cms3_triboson_v2.nisoTrack_5gev(); }
	const int &nisoTrack_mt2() { return cms3_triboson_v2.nisoTrack_mt2(); }
	const int &nisoTrack_PFLep5_woverlaps() { return cms3_triboson_v2.nisoTrack_PFLep5_woverlaps(); }
	const int &nisoTrack_PFHad10_woverlaps() { return cms3_triboson_v2.nisoTrack_PFHad10_woverlaps(); }
	const int &ngamma() { return cms3_triboson_v2.ngamma(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gamma_p4() { return cms3_triboson_v2.gamma_p4(); }
	const vector<float> &gamma_pt() { return cms3_triboson_v2.gamma_pt(); }
	const vector<float> &gamma_eta() { return cms3_triboson_v2.gamma_eta(); }
	const vector<float> &gamma_phi() { return cms3_triboson_v2.gamma_phi(); }
	const vector<float> &gamma_mass() { return cms3_triboson_v2.gamma_mass(); }
	const vector<int> &gamma_mcMatchId() { return cms3_triboson_v2.gamma_mcMatchId(); }
	const vector<float> &gamma_genPt() { return cms3_triboson_v2.gamma_genPt(); }
	const vector<float> &gamma_genIso() { return cms3_triboson_v2.gamma_genIso(); }
	const vector<float> &gamma_chHadIso() { return cms3_triboson_v2.gamma_chHadIso(); }
	const vector<float> &gamma_neuHadIso() { return cms3_triboson_v2.gamma_neuHadIso(); }
	const vector<float> &gamma_phIso() { return cms3_triboson_v2.gamma_phIso(); }
	const vector<float> &gamma_sigmaIetaIeta() { return cms3_triboson_v2.gamma_sigmaIetaIeta(); }
	const vector<float> &gamma_r9() { return cms3_triboson_v2.gamma_r9(); }
	const vector<float> &gamma_hOverE() { return cms3_triboson_v2.gamma_hOverE(); }
	const vector<float> &gamma_hOverE_online() { return cms3_triboson_v2.gamma_hOverE_online(); }
	const vector<int> &gamma_idCutBased() { return cms3_triboson_v2.gamma_idCutBased(); }
	const vector<float> &gamma_ecpfclusiso() { return cms3_triboson_v2.gamma_ecpfclusiso(); }
	const vector<float> &gamma_hcpfclusiso() { return cms3_triboson_v2.gamma_hcpfclusiso(); }
	const vector<float> &gamma_hollowtkiso03() { return cms3_triboson_v2.gamma_hollowtkiso03(); }
	const vector<int> &gamma_genIsPromptFinalState() { return cms3_triboson_v2.gamma_genIsPromptFinalState(); }
	const vector<float> &gamma_drMinParton() { return cms3_triboson_v2.gamma_drMinParton(); }
	const int &ngenPart() { return cms3_triboson_v2.ngenPart(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genPart_p4() { return cms3_triboson_v2.genPart_p4(); }
	const vector<float> &genPart_pt() { return cms3_triboson_v2.genPart_pt(); }
	const vector<float> &genPart_eta() { return cms3_triboson_v2.genPart_eta(); }
	const vector<float> &genPart_phi() { return cms3_triboson_v2.genPart_phi(); }
	const vector<float> &genPart_mass() { return cms3_triboson_v2.genPart_mass(); }
	const vector<int> &genPart_pdgId() { return cms3_triboson_v2.genPart_pdgId(); }
	const vector<int> &genPart_status() { return cms3_triboson_v2.genPart_status(); }
	const vector<float> &genPart_charge() { return cms3_triboson_v2.genPart_charge(); }
	const vector<int> &genPart_motherId() { return cms3_triboson_v2.genPart_motherId(); }
	const vector<int> &genPart_grandmaId() { return cms3_triboson_v2.genPart_grandmaId(); }
	const vector<bool> &genPart_isp6status3() { return cms3_triboson_v2.genPart_isp6status3(); }
	const int &ngenLep() { return cms3_triboson_v2.ngenLep(); }
	const vector<float> &genLep_pt() { return cms3_triboson_v2.genLep_pt(); }
	const vector<float> &genLep_eta() { return cms3_triboson_v2.genLep_eta(); }
	const vector<float> &genLep_phi() { return cms3_triboson_v2.genLep_phi(); }
	const vector<float> &genLep_mass() { return cms3_triboson_v2.genLep_mass(); }
	const vector<int> &genLep_pdgId() { return cms3_triboson_v2.genLep_pdgId(); }
	const vector<int> &genLep_status() { return cms3_triboson_v2.genLep_status(); }
	const vector<float> &genLep_charge() { return cms3_triboson_v2.genLep_charge(); }
	const vector<int> &genLep_sourceId() { return cms3_triboson_v2.genLep_sourceId(); }
	const vector<bool> &genLep_isp6status3() { return cms3_triboson_v2.genLep_isp6status3(); }
	const int &ngenTau() { return cms3_triboson_v2.ngenTau(); }
	const vector<float> &genTau_pt() { return cms3_triboson_v2.genTau_pt(); }
	const vector<float> &genTau_eta() { return cms3_triboson_v2.genTau_eta(); }
	const vector<float> &genTau_phi() { return cms3_triboson_v2.genTau_phi(); }
	const vector<float> &genTau_mass() { return cms3_triboson_v2.genTau_mass(); }
	const vector<int> &genTau_pdgId() { return cms3_triboson_v2.genTau_pdgId(); }
	const vector<int> &genTau_status() { return cms3_triboson_v2.genTau_status(); }
	const vector<float> &genTau_charge() { return cms3_triboson_v2.genTau_charge(); }
	const vector<int> &genTau_sourceId() { return cms3_triboson_v2.genTau_sourceId(); }
	const int &ngenLepFromTau() { return cms3_triboson_v2.ngenLepFromTau(); }
	const vector<float> &genLepFromTau_pt() { return cms3_triboson_v2.genLepFromTau_pt(); }
	const vector<float> &genLepFromTau_eta() { return cms3_triboson_v2.genLepFromTau_eta(); }
	const vector<float> &genLepFromTau_phi() { return cms3_triboson_v2.genLepFromTau_phi(); }
	const vector<float> &genLepFromTau_mass() { return cms3_triboson_v2.genLepFromTau_mass(); }
	const vector<int> &genLepFromTau_pdgId() { return cms3_triboson_v2.genLepFromTau_pdgId(); }
	const vector<int> &genLepFromTau_status() { return cms3_triboson_v2.genLepFromTau_status(); }
	const vector<float> &genLepFromTau_charge() { return cms3_triboson_v2.genLepFromTau_charge(); }
	const vector<int> &genLepFromTau_sourceId() { return cms3_triboson_v2.genLepFromTau_sourceId(); }
	const int &njets() { return cms3_triboson_v2.njets(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_p4() { return cms3_triboson_v2.jets_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &removed_jets_p4() { return cms3_triboson_v2.removed_jets_p4(); }
	const vector<float> &removed_jets_csv() { return cms3_triboson_v2.removed_jets_csv(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_medb_p4() { return cms3_triboson_v2.jets_medb_p4(); }
	const int &njets_up() { return cms3_triboson_v2.njets_up(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_up_p4() { return cms3_triboson_v2.jets_up_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_medb_up_p4() { return cms3_triboson_v2.jets_medb_up_p4(); }
	const vector<float> &jets_csv() { return cms3_triboson_v2.jets_csv(); }
	const vector<float> &jets_up_csv() { return cms3_triboson_v2.jets_up_csv(); }
	const int &njets_dn() { return cms3_triboson_v2.njets_dn(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_dn_p4() { return cms3_triboson_v2.jets_dn_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jets_medb_dn_p4() { return cms3_triboson_v2.jets_medb_dn_p4(); }
	const vector<float> &jets_dn_csv() { return cms3_triboson_v2.jets_dn_csv(); }
	const vector<float> &jets_muf() { return cms3_triboson_v2.jets_muf(); }
	const vector<int> &jets_mcFlavour() { return cms3_triboson_v2.jets_mcFlavour(); }
	const vector<int> &jets_mcHadronFlav() { return cms3_triboson_v2.jets_mcHadronFlav(); }
	const int &nhighPtPFcands() { return cms3_triboson_v2.nhighPtPFcands(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &highPtPFcands_p4() { return cms3_triboson_v2.highPtPFcands_p4(); }
	const vector<float> &highPtPFcands_dz() { return cms3_triboson_v2.highPtPFcands_dz(); }
	const vector<int> &highPtPFcands_pdgId() { return cms3_triboson_v2.highPtPFcands_pdgId(); }
	const float &ht() { return cms3_triboson_v2.ht(); }
	const float &ht_up() { return cms3_triboson_v2.ht_up(); }
	const float &ht_dn() { return cms3_triboson_v2.ht_dn(); }
	const float &metsig_unofficial() { return cms3_triboson_v2.metsig_unofficial(); }
	const float &metsig_unofficial_up() { return cms3_triboson_v2.metsig_unofficial_up(); }
	const float &metsig_unofficial_dn() { return cms3_triboson_v2.metsig_unofficial_dn(); }
	const float &mt_lep1() { return cms3_triboson_v2.mt_lep1(); }
	const float &mt2() { return cms3_triboson_v2.mt2(); }
	const float &mt2_up() { return cms3_triboson_v2.mt2_up(); }
	const float &mt2_dn() { return cms3_triboson_v2.mt2_dn(); }
	const float &mt2j() { return cms3_triboson_v2.mt2j(); }
	const float &mt2b() { return cms3_triboson_v2.mt2b(); }
	const float &mt2b_up() { return cms3_triboson_v2.mt2b_up(); }
	const float &mt2b_dn() { return cms3_triboson_v2.mt2b_dn(); }
	const float &mt2_genmet() { return cms3_triboson_v2.mt2_genmet(); }
	const float &mt2b_genmet() { return cms3_triboson_v2.mt2b_genmet(); }
	const float &mjj_mindphi() { return cms3_triboson_v2.mjj_mindphi(); }
	const float &mjj() { return cms3_triboson_v2.mjj(); }
	const float &mbb_csv() { return cms3_triboson_v2.mbb_csv(); }
	const float &mbb_bpt() { return cms3_triboson_v2.mbb_bpt(); }
	const float &dphi_jj() { return cms3_triboson_v2.dphi_jj(); }
	const float &dphi_ll() { return cms3_triboson_v2.dphi_ll(); }
	const float &sum_mlb() { return cms3_triboson_v2.sum_mlb(); }
	const float &deta_jj() { return cms3_triboson_v2.deta_jj(); }
	const float &dR_jj() { return cms3_triboson_v2.dR_jj(); }
	const float &dphi_metj1() { return cms3_triboson_v2.dphi_metj1(); }
	const float &dphi_metj2() { return cms3_triboson_v2.dphi_metj2(); }
	const float &dphi_genmetj1() { return cms3_triboson_v2.dphi_genmetj1(); }
	const float &dphi_genmetj2() { return cms3_triboson_v2.dphi_genmetj2(); }
	const float &mjj_mindphi_up() { return cms3_triboson_v2.mjj_mindphi_up(); }
	const float &mjj_up() { return cms3_triboson_v2.mjj_up(); }
	const float &mbb_csv_up() { return cms3_triboson_v2.mbb_csv_up(); }
	const float &mbb_bpt_up() { return cms3_triboson_v2.mbb_bpt_up(); }
	const float &dphi_jj_up() { return cms3_triboson_v2.dphi_jj_up(); }
	const float &dphi_ll_up() { return cms3_triboson_v2.dphi_ll_up(); }
	const float &sum_mlb_up() { return cms3_triboson_v2.sum_mlb_up(); }
	const float &deta_jj_up() { return cms3_triboson_v2.deta_jj_up(); }
	const float &dR_jj_up() { return cms3_triboson_v2.dR_jj_up(); }
	const float &dphi_metj1_up() { return cms3_triboson_v2.dphi_metj1_up(); }
	const float &dphi_metj2_up() { return cms3_triboson_v2.dphi_metj2_up(); }
	const float &mjj_mindphi_dn() { return cms3_triboson_v2.mjj_mindphi_dn(); }
	const float &mjj_dn() { return cms3_triboson_v2.mjj_dn(); }
	const float &mbb_csv_dn() { return cms3_triboson_v2.mbb_csv_dn(); }
	const float &mbb_bpt_dn() { return cms3_triboson_v2.mbb_bpt_dn(); }
	const float &dphi_jj_dn() { return cms3_triboson_v2.dphi_jj_dn(); }
	const float &dphi_ll_dn() { return cms3_triboson_v2.dphi_ll_dn(); }
	const float &sum_mlb_dn() { return cms3_triboson_v2.sum_mlb_dn(); }
	const float &deta_jj_dn() { return cms3_triboson_v2.deta_jj_dn(); }
	const float &dR_jj_dn() { return cms3_triboson_v2.dR_jj_dn(); }
	const float &dphi_metj1_dn() { return cms3_triboson_v2.dphi_metj1_dn(); }
	const float &dphi_metj2_dn() { return cms3_triboson_v2.dphi_metj2_dn(); }
	const float &weight_btagsf() { return cms3_triboson_v2.weight_btagsf(); }
	const float &weight_btagsf_heavy_UP() { return cms3_triboson_v2.weight_btagsf_heavy_UP(); }
	const float &weight_btagsf_light_UP() { return cms3_triboson_v2.weight_btagsf_light_UP(); }
	const float &weight_btagsf_heavy_DN() { return cms3_triboson_v2.weight_btagsf_heavy_DN(); }
	const float &weight_btagsf_light_DN() { return cms3_triboson_v2.weight_btagsf_light_DN(); }
	const float &chpfcands_0013_pt() { return cms3_triboson_v2.chpfcands_0013_pt(); }
	const float &chpfcands_1316_pt() { return cms3_triboson_v2.chpfcands_1316_pt(); }
	const float &chpfcands_1624_pt() { return cms3_triboson_v2.chpfcands_1624_pt(); }
	const float &chpfcands_2430_pt() { return cms3_triboson_v2.chpfcands_2430_pt(); }
	const float &chpfcands_30in_pt() { return cms3_triboson_v2.chpfcands_30in_pt(); }
	const float &phpfcands_0013_pt() { return cms3_triboson_v2.phpfcands_0013_pt(); }
	const float &phpfcands_1316_pt() { return cms3_triboson_v2.phpfcands_1316_pt(); }
	const float &phpfcands_1624_pt() { return cms3_triboson_v2.phpfcands_1624_pt(); }
	const float &phpfcands_2430_pt() { return cms3_triboson_v2.phpfcands_2430_pt(); }
	const float &phpfcands_30in_pt() { return cms3_triboson_v2.phpfcands_30in_pt(); }
	const float &nupfcands_0013_pt() { return cms3_triboson_v2.nupfcands_0013_pt(); }
	const float &nupfcands_1316_pt() { return cms3_triboson_v2.nupfcands_1316_pt(); }
	const float &nupfcands_1624_pt() { return cms3_triboson_v2.nupfcands_1624_pt(); }
	const float &nupfcands_2430_pt() { return cms3_triboson_v2.nupfcands_2430_pt(); }
	const float &nupfcands_30in_pt() { return cms3_triboson_v2.nupfcands_30in_pt(); }
	const float &chpfcands_0013_sumet() { return cms3_triboson_v2.chpfcands_0013_sumet(); }
	const float &chpfcands_1316_sumet() { return cms3_triboson_v2.chpfcands_1316_sumet(); }
	const float &chpfcands_1624_sumet() { return cms3_triboson_v2.chpfcands_1624_sumet(); }
	const float &chpfcands_2430_sumet() { return cms3_triboson_v2.chpfcands_2430_sumet(); }
	const float &chpfcands_30in_sumet() { return cms3_triboson_v2.chpfcands_30in_sumet(); }
	const float &phpfcands_0013_sumet() { return cms3_triboson_v2.phpfcands_0013_sumet(); }
	const float &phpfcands_1316_sumet() { return cms3_triboson_v2.phpfcands_1316_sumet(); }
	const float &phpfcands_1624_sumet() { return cms3_triboson_v2.phpfcands_1624_sumet(); }
	const float &phpfcands_2430_sumet() { return cms3_triboson_v2.phpfcands_2430_sumet(); }
	const float &phpfcands_30in_sumet() { return cms3_triboson_v2.phpfcands_30in_sumet(); }
	const float &nupfcands_0013_sumet() { return cms3_triboson_v2.nupfcands_0013_sumet(); }
	const float &nupfcands_1316_sumet() { return cms3_triboson_v2.nupfcands_1316_sumet(); }
	const float &nupfcands_1624_sumet() { return cms3_triboson_v2.nupfcands_1624_sumet(); }
	const float &nupfcands_2430_sumet() { return cms3_triboson_v2.nupfcands_2430_sumet(); }
	const float &nupfcands_30in_sumet() { return cms3_triboson_v2.nupfcands_30in_sumet(); }
	const float &chpfcands_0013_phi() { return cms3_triboson_v2.chpfcands_0013_phi(); }
	const float &chpfcands_1316_phi() { return cms3_triboson_v2.chpfcands_1316_phi(); }
	const float &chpfcands_1624_phi() { return cms3_triboson_v2.chpfcands_1624_phi(); }
	const float &chpfcands_2430_phi() { return cms3_triboson_v2.chpfcands_2430_phi(); }
	const float &chpfcands_30in_phi() { return cms3_triboson_v2.chpfcands_30in_phi(); }
	const float &phpfcands_0013_phi() { return cms3_triboson_v2.phpfcands_0013_phi(); }
	const float &phpfcands_1316_phi() { return cms3_triboson_v2.phpfcands_1316_phi(); }
	const float &phpfcands_1624_phi() { return cms3_triboson_v2.phpfcands_1624_phi(); }
	const float &phpfcands_2430_phi() { return cms3_triboson_v2.phpfcands_2430_phi(); }
	const float &phpfcands_30in_phi() { return cms3_triboson_v2.phpfcands_30in_phi(); }
	const float &nupfcands_0013_phi() { return cms3_triboson_v2.nupfcands_0013_phi(); }
	const float &nupfcands_1316_phi() { return cms3_triboson_v2.nupfcands_1316_phi(); }
	const float &nupfcands_1624_phi() { return cms3_triboson_v2.nupfcands_1624_phi(); }
	const float &nupfcands_2430_phi() { return cms3_triboson_v2.nupfcands_2430_phi(); }
	const float &nupfcands_30in_phi() { return cms3_triboson_v2.nupfcands_30in_phi(); }
	const float &met_T1CHS_pt() { return cms3_triboson_v2.met_T1CHS_pt(); }
	const float &met_T1CHS_phi() { return cms3_triboson_v2.met_T1CHS_phi(); }
	const float &met_T1CHS_fromCORE_pt() { return cms3_triboson_v2.met_T1CHS_fromCORE_pt(); }
	const float &met_T1CHS_fromCORE_phi() { return cms3_triboson_v2.met_T1CHS_fromCORE_phi(); }
	const float &met_T1CHS_miniAOD_CORE_pt() { return cms3_triboson_v2.met_T1CHS_miniAOD_CORE_pt(); }
	const float &met_T1CHS_miniAOD_CORE_phi() { return cms3_triboson_v2.met_T1CHS_miniAOD_CORE_phi(); }
	const float &met_T1CHS_miniAOD_CORE_up_pt() { return cms3_triboson_v2.met_T1CHS_miniAOD_CORE_up_pt(); }
	const float &met_T1CHS_miniAOD_CORE_up_phi() { return cms3_triboson_v2.met_T1CHS_miniAOD_CORE_up_phi(); }
	const float &met_T1CHS_miniAOD_CORE_dn_pt() { return cms3_triboson_v2.met_T1CHS_miniAOD_CORE_dn_pt(); }
	const float &met_T1CHS_miniAOD_CORE_dn_phi() { return cms3_triboson_v2.met_T1CHS_miniAOD_CORE_dn_phi(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_lep1_p4() { return cms3_triboson_v2.decayedphoton_lep1_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_lep2_p4() { return cms3_triboson_v2.decayedphoton_lep2_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_bosn_p4() { return cms3_triboson_v2.decayedphoton_bosn_p4(); }
	const float &decayedphoton_mt2() { return cms3_triboson_v2.decayedphoton_mt2(); }
	const int &hyp_type() { return cms3_triboson_v2.hyp_type(); }
	const int &evt_type() { return cms3_triboson_v2.evt_type(); }
	const int &mass_gluino() { return cms3_triboson_v2.mass_gluino(); }
	const int &mass_LSP() { return cms3_triboson_v2.mass_LSP(); }
	const int &mass_chi() { return cms3_triboson_v2.mass_chi(); }
	const float &isrboost() { return cms3_triboson_v2.isrboost(); }
	const int &isr_njets() { return cms3_triboson_v2.isr_njets(); }
	const float &isr_weight() { return cms3_triboson_v2.isr_weight(); }
	const float &isr_unc() { return cms3_triboson_v2.isr_unc(); }
	const vector<float> &weightsf_lepid() { return cms3_triboson_v2.weightsf_lepid(); }
	const vector<float> &weightsf_lepiso() { return cms3_triboson_v2.weightsf_lepiso(); }
	const vector<float> &weightsf_lepip() { return cms3_triboson_v2.weightsf_lepip(); }
	const vector<float> &weightsf_lepreco() { return cms3_triboson_v2.weightsf_lepreco(); }
	const vector<float> &weightsf_lepconv() { return cms3_triboson_v2.weightsf_lepconv(); }
	const vector<float> &weightsf_lepid_FS() { return cms3_triboson_v2.weightsf_lepid_FS(); }
	const vector<float> &weightsf_lepiso_FS() { return cms3_triboson_v2.weightsf_lepiso_FS(); }
	const vector<float> &weightsf_lepip_FS() { return cms3_triboson_v2.weightsf_lepip_FS(); }
}
