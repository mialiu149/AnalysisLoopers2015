...
// makeCMS3ClassFiles("chain files", "t", "V80_03", "V80_03_np", "v80_03")
...
void LoadAllBranches(); 
	...
	const vector<float> &highPtPFcands_pt();
	const vector<float> &highPtPFcands_eta();
	const vector<float> &highPtPFcands_phi();
	const vector<float> &highPtPFcands_mass();
	const vector<float> &highPtPFcands_absIso();
	const vector<float> &highPtPFcands_relIsoAn04();
	const vector<float> &highPtPFcands_dz();
	const vector<float> &highPtPFcands_pdgId();
	const vector<float> &highPtPFcands_mcMatchId();
