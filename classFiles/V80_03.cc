...
void V80_03::Init(TTree *tree) {
  ...
  tree->SetMakeClass(1);
	...
	mbb_jup_branch = 0;
	if (tree->GetBranch("mbb_jup") != 0) {
		mbb_jup_branch = tree->GetBranch("mbb_jup");
		if (mbb_jup_branch) {mbb_jup_branch->SetAddress(&mbb_jup_);}
	}
	mbb_jdown_branch = 0;
	if (tree->GetBranch("mbb_jdown") != 0) {
		mbb_jdown_branch = tree->GetBranch("mbb_jdown");
		if (mbb_jdown_branch) {mbb_jdown_branch->SetAddress(&mbb_jdown_);}
	}
	mct_branch = 0;
	if (tree->GetBranch("mct") != 0) {
		mct_branch = tree->GetBranch("mct");
		if (mct_branch) {mct_branch->SetAddress(&mct_);}
	}
	mct_jup_branch = 0;
	if (tree->GetBranch("mct_jup") != 0) {
		mct_jup_branch = tree->GetBranch("mct_jup");
		if (mct_jup_branch) {mct_jup_branch->SetAddress(&mct_jup_);}
	}
	mct_jdown_branch = 0;
	if (tree->GetBranch("mct_jdown") != 0) {
		mct_jdown_branch = tree->GetBranch("mct_jdown");
		if (mct_jdown_branch) {mct_jdown_branch->SetAddress(&mct_jdown_);}
	}
	MT2W_branch = 0;
	...
	lep1_gfit_ptErr_branch = 0;
	if (tree->GetBranch("lep1_gfit_ptErr") != 0) {
		lep1_gfit_ptErr_branch = tree->GetBranch("lep1_gfit_ptErr");
		if (lep1_gfit_ptErr_branch) {lep1_gfit_ptErr_branch->SetAddress(&lep1_gfit_ptErr_);}
	}
	lep1_gfit_pt_branch = 0;
	if (tree->GetBranch("lep1_gfit_pt") != 0) {
		lep1_gfit_pt_branch = tree->GetBranch("lep1_gfit_pt");
		if (lep1_gfit_pt_branch) {lep1_gfit_pt_branch->SetAddress(&lep1_gfit_pt_);}
	}
	...
	lep2_gfit_ptErr_branch = 0;
	if (tree->GetBranch("lep2_gfit_ptErr") != 0) {
		lep2_gfit_ptErr_branch = tree->GetBranch("lep2_gfit_ptErr");
		if (lep2_gfit_ptErr_branch) {lep2_gfit_ptErr_branch->SetAddress(&lep2_gfit_ptErr_);}
	}
	lep2_gfit_pt_branch = 0;
	if (tree->GetBranch("lep2_gfit_pt") != 0) {
		lep2_gfit_pt_branch = tree->GetBranch("lep2_gfit_pt");
		if (lep2_gfit_pt_branch) {lep2_gfit_pt_branch->SetAddress(&lep2_gfit_pt_);}
	}
	...
	ak4_mbb_branch = 0;
	if (tree->GetBranch("ak4_mbb") != 0) {
		ak4_mbb_branch = tree->GetBranch("ak4_mbb");
		if (ak4_mbb_branch) {ak4_mbb_branch->SetAddress(&ak4_mbb_);}
	}
	ak4_mct_branch = 0;
	if (tree->GetBranch("ak4_mct") != 0) {
		ak4_mct_branch = tree->GetBranch("ak4_mct");
		if (ak4_mct_branch) {ak4_mct_branch->SetAddress(&ak4_mct_);}
	}
	...
	jup_ak4_mbb_branch = 0;
	if (tree->GetBranch("jup_ak4_mbb") != 0) {
		jup_ak4_mbb_branch = tree->GetBranch("jup_ak4_mbb");
		if (jup_ak4_mbb_branch) {jup_ak4_mbb_branch->SetAddress(&jup_ak4_mbb_);}
	}
	jup_ak4_mct_branch = 0;
	if (tree->GetBranch("jup_ak4_mct") != 0) {
		jup_ak4_mct_branch = tree->GetBranch("jup_ak4_mct");
		if (jup_ak4_mct_branch) {jup_ak4_mct_branch->SetAddress(&jup_ak4_mct_);}
	}
	...
	jdown_ak4_mbb_branch = 0;
	if (tree->GetBranch("jdown_ak4_mbb") != 0) {
		jdown_ak4_mbb_branch = tree->GetBranch("jdown_ak4_mbb");
		if (jdown_ak4_mbb_branch) {jdown_ak4_mbb_branch->SetAddress(&jdown_ak4_mbb_);}
	}
	jdown_ak4_mct_branch = 0;
	if (tree->GetBranch("jdown_ak4_mct") != 0) {
		jdown_ak4_mct_branch = tree->GetBranch("jdown_ak4_mct");
		if (jdown_ak4_mct_branch) {jdown_ak4_mct_branch->SetAddress(&jdown_ak4_mct_);}
	}
	...
	highPtPFcands_pt_branch = 0;
	if (tree->GetBranch("highPtPFcands_pt") != 0) {
	...
	highPtPFcands_eta_branch = 0;
	if (tree->GetBranch("highPtPFcands_eta") != 0) {
	...
	highPtPFcands_phi_branch = 0;
	if (tree->GetBranch("highPtPFcands_phi") != 0) {
	...
	highPtPFcands_mass_branch = 0;
	if (tree->GetBranch("highPtPFcands_mass") != 0) {
	...
	highPtPFcands_absIso_branch = 0;
	if (tree->GetBranch("highPtPFcands_absIso") != 0) {
	...
	highPtPFcands_relIsoAn04_branch = 0;
	if (tree->GetBranch("highPtPFcands_relIsoAn04") != 0) {
		highPtPFcands_relIsoAn04_branch = tree->GetBranch("highPtPFcands_relIsoAn04");
		if (highPtPFcands_relIsoAn04_branch) {highPtPFcands_relIsoAn04_branch->SetAddress(&highPtPFcands_relIsoAn04_);}
	}
	...
	highPtPFcands_mcMatchId_branch = 0;
	if (tree->GetBranch("highPtPFcands_mcMatchId") != 0) {
...
void V80_03::GetEntry(unsigned int idx) 
	// this only marks branches as not loaded, saving a lot of time
	{
		...
		mbb_isLoaded = false;
		mbb_jup_isLoaded = false;
		mbb_jdown_isLoaded = false;
		mct_isLoaded = false;
		mct_jup_isLoaded = false;
		mct_jdown_isLoaded = false;
		MT2W_isLoaded = false;
		...
		lep1_gfit_ptErr_isLoaded = false;
		lep1_gfit_pt_isLoaded = false;
		...
		lep2_gfit_ptErr_isLoaded = false;
		lep2_gfit_pt_isLoaded = false;
		...
		ak4_mbb_isLoaded = false;
		ak4_mct_isLoaded = false;
		...
		jup_ak4_mbb_isLoaded = false;
		jup_ak4_mct_isLoaded = false;
		...
		jdown_ak4_mbb_isLoaded = false;
		jdown_ak4_mct_isLoaded = false;
		...
		highPtPFcands_relIsoAn04_isLoaded = false;
	...
	// load all branches
{
	...
	if (mbb_branch != 0) mbb();
	if (mbb_jup_branch != 0) mbb_jup();
	if (mbb_jdown_branch != 0) mbb_jdown();
	if (mct_branch != 0) mct();
	if (mct_jup_branch != 0) mct_jup();
	if (mct_jdown_branch != 0) mct_jdown();
	...
	if (lep1_gfit_ptErr_branch != 0) lep1_gfit_ptErr();
	if (lep1_gfit_pt_branch != 0) lep1_gfit_pt();
	...
	if (lep2_gfit_ptErr_branch != 0) lep2_gfit_ptErr();
	if (lep2_gfit_pt_branch != 0) lep2_gfit_pt();
	...
	if (ak4_mbb_branch != 0) ak4_mbb();
	if (ak4_mct_branch != 0) ak4_mct();
	...
	if (jup_ak4_mbb_branch != 0) jup_ak4_mbb();
	if (jup_ak4_mct_branch != 0) jup_ak4_mct();
	...
	if (jdown_ak4_mbb_branch != 0) jdown_ak4_mbb();
	if (jdown_ak4_mct_branch != 0) jdown_ak4_mct();
	...
	if (highPtPFcands_relIsoAn04_branch != 0) highPtPFcands_relIsoAn04();
	...
	const float &V80_03::pfmet_phi_jup()
	{
	...
	const float &V80_03::pfmet_jdown()
	{
	...
	const float &V80_03::pfmet_phi_jdown()
	{
	...
	const float &V80_03::pfmet_phi_rl()
	{
	...
	const float &V80_03::pfmet_rl_jup()
	{
	...
	const float &V80_03::pfmet_phi_rl_jup()
	{
	...
	const float &V80_03::pfmet_rl_jdown()
	{
	...
	const float &V80_03::pfmet_phi_rl_jdown()
	{
	...
	const float &V80_03::xsec_uncert()
	{
	...
	const bool &	V80_03::filt_badmuons()
	{
	...
	const bool &	V80_03::filt_duplicatemuons()
	{
	...
	const bool &	V80_03::filt_nobadmuons()
	{
	...
	const unsigned int &V80_03::nEvents()
	{
	...
	const unsigned int &V80_03::nEvents_goodvtx()
	{
	...
	const unsigned int &V80_03::nEvents_MET30()
	{
	...
	const unsigned int &V80_03::nEvents_1goodlep()
	{
	...
	const unsigned int &V80_03::nEvents_2goodjets()
	{
	...
	const int &V80_03::is1lepFromTop()
	{
	...
	const float &V80_03::mbb_jup()
	{
		if (not mbb_jup_isLoaded) {
			if (mbb_jup_branch != 0) {
				mbb_jup_branch->GetEntry(index);
			} else { 
				printf("branch mbb_jup_branch does not exist!\n");
				exit(1);
			}
			mbb_jup_isLoaded = true;
		}
		return mbb_jup_;
	}
	const float &V80_03::mbb_jdown()
	{
		if (not mbb_jdown_isLoaded) {
			if (mbb_jdown_branch != 0) {
				mbb_jdown_branch->GetEntry(index);
			} else { 
				printf("branch mbb_jdown_branch does not exist!\n");
				exit(1);
			}
			mbb_jdown_isLoaded = true;
		}
		return mbb_jdown_;
	}
	const float &V80_03::mct()
	{
		if (not mct_isLoaded) {
			if (mct_branch != 0) {
				mct_branch->GetEntry(index);
			} else { 
				printf("branch mct_branch does not exist!\n");
				exit(1);
			}
			mct_isLoaded = true;
		}
	...
	const float &V80_03::mct_jup()
	{
		if (not mct_jup_isLoaded) {
			if (mct_jup_branch != 0) {
				mct_jup_branch->GetEntry(index);
			} else { 
				printf("branch mct_jup_branch does not exist!\n");
				exit(1);
			}
			mct_jup_isLoaded = true;
		}
		return mct_jup_;
	}
	const float &V80_03::mct_jdown()
	{
		if (not mct_jdown_isLoaded) {
			if (mct_jdown_branch != 0) {
				mct_jdown_branch->GetEntry(index);
			} else { 
				printf("branch mct_jdown_branch does not exist!\n");
				exit(1);
			}
			mct_jdown_isLoaded = true;
		}
		return mct_jdown_;
	}
	const float &V80_03::MT2W()
	{
	...
	const float &V80_03::mindphi_met_j1_j2()
	{
	...
	const float &V80_03::mindphi_met_j1_j2_rl()
	{
	...
	const float &V80_03::mt_met_lep_rl()
	{
	...
	const float &V80_03::MT2W_rl_jup()
	{
	...
	const float &V80_03::mindphi_met_j1_j2_jup()
	{
	...
	const float &V80_03::mindphi_met_j1_j2_rl_jup()
	{
	...
	const float &V80_03::mt_met_lep_jup()
	{
	...
	const float &V80_03::mt_met_lep_rl_jup()
	{
	...
	const float &V80_03::MT2W_rl_jdown()
	{
	...
	const float &V80_03::mindphi_met_j1_j2_jdown()
	{
	...
	const float &V80_03::mindphi_met_j1_j2_rl_jdown()
	{
	...
	const float &V80_03::mt_met_lep_jdown()
	{
	...
	const float &V80_03::mt_met_lep_rl_jdown()
	{
	...
	const float &V80_03::hadronic_top_chi2()
	{
	...
	const float &V80_03::ak4pfjets_rho()
	{
	...
	const float &V80_03::pdf_up_weight()
	{
	...
	const float &V80_03::pdf_down_weight()
	{
	...
	const vector<string> &V80_03::genweightsID()
	{
	...
	const vector<float> &V80_03::genweights()
	{
	...
	const float &V80_03::weight_btagsf()
	{
	...
	const float &V80_03::weight_btagsf_heavy_UP()
	{
	...
	const float &V80_03::weight_btagsf_light_UP()
	{
	...
	const float &V80_03::weight_btagsf_heavy_DN()
	{
	...
	const float &V80_03::weight_btagsf_light_DN()
	{
	...
	const float &V80_03::weight_btagsf_fastsim_UP()
	{
	...
	const float &V80_03::weight_btagsf_fastsim_DN()
	{
	...
	const float &V80_03::weight_lepSF()
	{
	...
	const float &V80_03::weight_lepSF_up()
	{
	...
	const float &V80_03::weight_lepSF_down()
	{
	...
	const float &V80_03::weight_vetoLepSF()
	{
	...
	const float &V80_03::weight_vetoLepSF_up()
	{
	...
	const float &V80_03::weight_vetoLepSF_down()
	{
	...
	const float &V80_03::weight_lepSF_fastSim()
	{
	...
	const float &V80_03::weight_lepSF_fastSim_up()
	{
	...
	const float &V80_03::weight_lepSF_fastSim_down()
	{
	...
	const float &V80_03::weight_ISRup()
	{
	...
	const float &V80_03::weight_ISRdown()
	{
	...
	const float &V80_03::weight_PUup()
	{
	...
	const float &V80_03::weight_PUdown()
	{
	...
	const float &V80_03::weight_ISRnjets()
	{
	...
	const float &V80_03::weight_ISRnjets_UP()
	{
	...
	const float &V80_03::weight_ISRnjets_DN()
	{
	...
	const bool &	V80_03::filt_fastsimjets()
	{
	...
	const bool &	V80_03::filt_fastsimjets_jup()
	{
	...
	const bool &	V80_03::filt_fastsimjets_jdown()
	{
	...
	const bool &	V80_03::filt_jetWithBadMuon()
	{
	...
	const bool &	V80_03::filt_jetWithBadMuon_jup()
	{
	...
	const bool &	V80_03::filt_jetWithBadMuon_jdown()
	{
	...
	const bool &	V80_03::filt_pfovercalomet()
	{
	...
	const vector<string> &V80_03::sparms_names()
	{
	...
	const vector<float> &V80_03::sparms_values()
	{
	...
	const int &V80_03::sparms_subProcessId()
	{
	...
	const float &V80_03::mass_chargino()
	{
	...
	const float &V80_03::mass_gluino()
	{
	...
	const bool &	V80_03::PassTrackVeto()
	{
	...
	const float &V80_03::topnessMod_rl()
	{
	...
	const float &V80_03::topnessMod_jup()
	{
	...
	const float &V80_03::topnessMod_rl_jup()
	{
	...
	const float &V80_03::topnessMod_jdown()
	{
	...
	const float &V80_03::topnessMod_rl_jdown()
	{
	...
	const float &V80_03::Mlb_closestb()
	{
	...
	const int &V80_03::HLT_SingleMuNoIso()
	{
	...
	const int &V80_03::HLT_SingleElNoIso()
	{
	...
	const int &V80_03::HLT_MET100_MHT100()
	{
	...
	const int &V80_03::HLT_Photon90_CaloIdL_PFHT500()
	{
	...
	const int &V80_03::HLT_Photon22_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon30_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon36_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon50_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon75_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon90_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon120_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon165_R9Id90_HE10_IsoM()
	{
	...
	const int &V80_03::HLT_Photon175()
	{
	...
	const int &V80_03::HLT_Photon165_HE10()
	{
	...
	const int &V80_03::ph_ngoodbtags()
	{
	...
	const float &V80_03::filt_badMuonFilter()
	{
	...
	const float &V80_03::filt_badChargedCandidateFilter()
	{
	...
	const float &V80_03::filt_cscbeamhalo2015()
	{
	...
	const float &V80_03::filt_cscbeamhalo()
	{
	...
	const float &V80_03::calomet_phi()
	{
	...
	const int &V80_03::lep1_production_type()
	{
	...
	const float &V80_03::lep1_MiniIso()
	{
	...
	const float &V80_03::lep1_relIso()
	{
	...
	const float &V80_03::lep1_gfit_ptErr()
	{
		if (not lep1_gfit_ptErr_isLoaded) {
			if (lep1_gfit_ptErr_branch != 0) {
				lep1_gfit_ptErr_branch->GetEntry(index);
			} else { 
				printf("branch lep1_gfit_ptErr_branch does not exist!\n");
				exit(1);
			}
			lep1_gfit_ptErr_isLoaded = true;
		}
		return lep1_gfit_ptErr_;
	}
	const float &V80_03::lep1_gfit_pt()
	{
		if (not lep1_gfit_pt_isLoaded) {
			if (lep1_gfit_pt_branch != 0) {
				lep1_gfit_pt_branch->GetEntry(index);
			} else { 
				printf("branch lep1_gfit_pt_branch does not exist!\n");
				exit(1);
			}
			lep1_gfit_pt_isLoaded = true;
		}
		return lep1_gfit_pt_;
	}
	const bool &	V80_03::lep1_passLooseID()
	{
	...
	const bool &	V80_03::lep1_passMediumID()
	{
	...
	const bool &	V80_03::lep1_passTightID()
	{
	...
	const bool &	V80_03::lep1_passVeto()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::lep1_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::lep1_mcp4()
	{
	...
	const int &V80_03::lep1_mc_motherid()
	{
	...
	const int &V80_03::lep2_production_type()
	{
	...
	const float &V80_03::lep2_MiniIso()
	{
	...
	const float &V80_03::lep2_relIso()
	{
	...
	const float &V80_03::lep2_gfit_ptErr()
	{
		if (not lep2_gfit_ptErr_isLoaded) {
			if (lep2_gfit_ptErr_branch != 0) {
				lep2_gfit_ptErr_branch->GetEntry(index);
			} else { 
				printf("branch lep2_gfit_ptErr_branch does not exist!\n");
				exit(1);
			}
			lep2_gfit_ptErr_isLoaded = true;
		}
		return lep2_gfit_ptErr_;
	}
	const float &V80_03::lep2_gfit_pt()
	{
		if (not lep2_gfit_pt_isLoaded) {
			if (lep2_gfit_pt_branch != 0) {
				lep2_gfit_pt_branch->GetEntry(index);
			} else { 
				printf("branch lep2_gfit_pt_branch does not exist!\n");
				exit(1);
			}
			lep2_gfit_pt_isLoaded = true;
		}
		return lep2_gfit_pt_;
	}
	const bool &	V80_03::lep2_passLooseID()
	{
	...
	const bool &	V80_03::lep2_passMediumID()
	{
	...
	const bool &	V80_03::lep2_passTightID()
	{
	...
	const bool &	V80_03::lep2_passVeto()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::lep2_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::lep2_mcp4()
	{
	...
	const int &V80_03::lep2_mc_motherid()
	{
	...
	const vector<float> &V80_03::ph_sigmaIEtaEta_fill5x5()
	{
	...
	const vector<float> &V80_03::ph_hOverE()
	{
	...
	const vector<float> &V80_03::ph_r9()
	{
	...
	const vector<float> &V80_03::ph_chiso()
	{
	...
	const vector<float> &V80_03::ph_nhiso()
	{
	...
	const vector<float> &V80_03::ph_phiso()
	{
	...
	const vector<bool> &V80_03::ph_idCutBased()
	{
	...
	const vector<int> &V80_03::ph_overlapJetId()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::ph_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::ph_mcp4()
	{
	...
	const vector<float> &V80_03::ph_pt()
	{
	...
	const vector<float> &V80_03::ph_eta()
	{
	...
	const vector<float> &V80_03::ph_phi()
	{
	...
	const vector<float> &V80_03::ph_mass()
	{
	...
	const vector<int> &V80_03::ph_mcMatchId()
	{
	...
	const vector<float> &V80_03::ph_genIso04()
	{
	...
	const vector<float> &V80_03::ph_drMinParton()
	{
	...
	const float &V80_03::ak4_mbb()
	{
		if (not ak4_mbb_isLoaded) {
			if (ak4_mbb_branch != 0) {
				ak4_mbb_branch->GetEntry(index);
			} else { 
				printf("branch ak4_mbb_branch does not exist!\n");
				exit(1);
			}
			ak4_mbb_isLoaded = true;
		}
		return ak4_mbb_;
	}
	const float &V80_03::ak4_mct()
	{
		if (not ak4_mct_isLoaded) {
			if (ak4_mct_branch != 0) {
				ak4_mct_branch->GetEntry(index);
			} else { 
				printf("branch ak4_mct_branch does not exist!\n");
				exit(1);
			}
			ak4_mct_isLoaded = true;
		}
		return ak4_mct_;
	}
	const float &V80_03::ak4_htratiom()
	{
	...
	const vector<float> &V80_03::dphi_ak4pfjet_met()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::ak4pfjets_p4()
	{
	...
	const vector<bool> &V80_03::ak4pfjets_passMEDbtag()
	{
	...
	const vector<float> &V80_03::ak4pfjets_CSV()
	{
	...
	const vector<float> &V80_03::ak4pfjets_mva()
	{
	...
	const vector<int> &V80_03::ak4pfjets_parton_flavor()
	{
	...
	const vector<int> &V80_03::ak4pfjets_hadron_flavor()
	{
	...
	const vector<bool> &V80_03::ak4pfjets_loose_puid()
	{
	...
	const vector<bool> &V80_03::ak4pfjets_loose_pfid()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::ak4pfjets_leadMEDbjet_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::ak4pfjets_leadbtag_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::ak4genjets_p4()
	{
	...
	const int &V80_03::jup_ngoodjets()
	{
	...
	const int &V80_03::jup_ngoodbtags()
	{
	...
	const float &V80_03::jup_ak4_mbb()
	{
		if (not jup_ak4_mbb_isLoaded) {
			if (jup_ak4_mbb_branch != 0) {
				jup_ak4_mbb_branch->GetEntry(index);
			} else { 
				printf("branch jup_ak4_mbb_branch does not exist!\n");
				exit(1);
			}
			jup_ak4_mbb_isLoaded = true;
		}
		return jup_ak4_mbb_;
	}
	const float &V80_03::jup_ak4_mct()
	{
		if (not jup_ak4_mct_isLoaded) {
			if (jup_ak4_mct_branch != 0) {
				jup_ak4_mct_branch->GetEntry(index);
			} else { 
				printf("branch jup_ak4_mct_branch does not exist!\n");
				exit(1);
			}
			jup_ak4_mct_isLoaded = true;
		}
		return jup_ak4_mct_;
	}
	const float &V80_03::jup_ak4_htratiom()
	{
	...
	const vector<float> &V80_03::jup_dphi_ak4pfjet_met()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::jup_ak4pfjets_p4()
	{
	...
	const vector<bool> &V80_03::jup_ak4pfjets_passMEDbtag()
	{
	...
	const vector<float> &V80_03::jup_ak4pfjets_CSV()
	{
	...
	const vector<float> &V80_03::jup_ak4pfjets_mva()
	{
	...
	const vector<int> &V80_03::jup_ak4pfjets_parton_flavor()
	{
	...
	const vector<int> &V80_03::jup_ak4pfjets_hadron_flavor()
	{
	...
	const vector<bool> &V80_03::jup_ak4pfjets_loose_puid()
	{
	...
	const vector<bool> &V80_03::jup_ak4pfjets_loose_pfid()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::jup_ak4pfjets_leadMEDbjet_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::jup_ak4pfjets_leadbtag_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::jup_ak4genjets_p4()
	{
	...
	const int &V80_03::jdown_ngoodjets()
	{
	...
	const int &V80_03::jdown_ngoodbtags()
	{
	...
	const float &V80_03::jdown_ak4_HT()
	{
	...
	const float &V80_03::jdown_ak4_mbb()
	{
		if (not jdown_ak4_mbb_isLoaded) {
			if (jdown_ak4_mbb_branch != 0) {
				jdown_ak4_mbb_branch->GetEntry(index);
			} else { 
				printf("branch jdown_ak4_mbb_branch does not exist!\n");
				exit(1);
			}
			jdown_ak4_mbb_isLoaded = true;
		}
		return jdown_ak4_mbb_;
	}
	const float &V80_03::jdown_ak4_mct()
	{
		if (not jdown_ak4_mct_isLoaded) {
			if (jdown_ak4_mct_branch != 0) {
				jdown_ak4_mct_branch->GetEntry(index);
			} else { 
				printf("branch jdown_ak4_mct_branch does not exist!\n");
				exit(1);
			}
			jdown_ak4_mct_isLoaded = true;
		}
		return jdown_ak4_mct_;
	}
	const float &V80_03::jdown_ak4_htratiom()
	{
	...
	const vector<float> &V80_03::jdown_dphi_ak4pfjet_met()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::jdown_ak4pfjets_p4()
	{
	...
	const vector<bool> &V80_03::jdown_ak4pfjets_passMEDbtag()
	{
	...
	const vector<float> &V80_03::jdown_ak4pfjets_CSV()
	{
	...
	const vector<float> &V80_03::jdown_ak4pfjets_mva()
	{
	...
	const vector<int> &V80_03::jdown_ak4pfjets_parton_flavor()
	{
	...
	const vector<int> &V80_03::jdown_ak4pfjets_hadron_flavor()
	{
	...
	const vector<bool> &V80_03::jdown_ak4pfjets_loose_puid()
	{
	...
	const vector<bool> &V80_03::jdown_ak4pfjets_loose_pfid()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::jdown_ak4pfjets_leadMEDbjet_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &V80_03::jdown_ak4pfjets_leadbtag_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::jdown_ak4genjets_p4()
	{
	...
	const vector<bool> &V80_03::genleps_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genleps_p4()
	{
	...
	const vector<int> &V80_03::genleps_id()
	{
	...
	const vector<int> &V80_03::genleps__genpsidx()
	{
	...
	const vector<int> &V80_03::genleps_status()
	{
	...
	const vector<bool> &V80_03::genleps_fromHardProcessDecayed()
	{
	...
	const vector<bool> &V80_03::genleps_fromHardProcessFinalState()
	{
	...
	const vector<bool> &V80_03::genleps_isHardProcess()
	{
	...
	const vector<bool> &V80_03::genleps_isLastCopy()
	{
	...
	const vector<int> &V80_03::genleps_gentaudecay()
	{
	...
	const int &V80_03::gen_nfromtleps_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genleps_motherp4()
	{
	...
	const vector<int> &V80_03::genleps_motherid()
	{
	...
	const vector<int> &V80_03::genleps_motheridx()
	{
	...
	const vector<int> &V80_03::genleps_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genleps_gmotherp4()
	{
	...
	const vector<int> &V80_03::genleps_gmotherid()
	{
	...
	const vector<int> &V80_03::genleps_gmotheridx()
	{
	...
	const vector<int> &V80_03::genleps_gmotherstatus()
	{
	...
	const vector<bool> &V80_03::gennus_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::gennus_p4()
	{
	...
	const vector<int> &V80_03::gennus_id()
	{
	...
	const vector<int> &V80_03::gennus__genpsidx()
	{
	...
	const vector<int> &V80_03::gennus_status()
	{
	...
	const vector<bool> &V80_03::gennus_fromHardProcessDecayed()
	{
	...
	const vector<bool> &V80_03::gennus_fromHardProcessFinalState()
	{
	...
	const vector<bool> &V80_03::gennus_isHardProcess()
	{
	...
	const vector<bool> &V80_03::gennus_isLastCopy()
	{
	...
	const vector<int> &V80_03::gennus_gentaudecay()
	{
	...
	const int &V80_03::gen_nfromtnus_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::gennus_motherp4()
	{
	...
	const vector<int> &V80_03::gennus_motherid()
	{
	...
	const vector<int> &V80_03::gennus_motheridx()
	{
	...
	const vector<int> &V80_03::gennus_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::gennus_gmotherp4()
	{
	...
	const vector<int> &V80_03::gennus_gmotherid()
	{
	...
	const vector<int> &V80_03::gennus_gmotheridx()
	{
	...
	const vector<int> &V80_03::gennus_gmotherstatus()
	{
	...
	const vector<bool> &V80_03::genqs_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genqs_p4()
	{
	...
	const vector<int> &V80_03::genqs_id()
	{
	...
	const vector<int> &V80_03::genqs__genpsidx()
	{
	...
	const vector<int> &V80_03::genqs_status()
	{
	...
	const vector<bool> &V80_03::genqs_fromHardProcessDecayed()
	{
	...
	const vector<bool> &V80_03::genqs_fromHardProcessFinalState()
	{
	...
	const vector<bool> &V80_03::genqs_isHardProcess()
	{
	...
	const vector<bool> &V80_03::genqs_isLastCopy()
	{
	...
	const vector<int> &V80_03::genqs_gentaudecay()
	{
	...
	const int &V80_03::gen_nfromtqs_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genqs_motherp4()
	{
	...
	const vector<int> &V80_03::genqs_motherid()
	{
	...
	const vector<int> &V80_03::genqs_motheridx()
	{
	...
	const vector<int> &V80_03::genqs_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genqs_gmotherp4()
	{
	...
	const vector<int> &V80_03::genqs_gmotherid()
	{
	...
	const vector<int> &V80_03::genqs_gmotheridx()
	{
	...
	const vector<int> &V80_03::genqs_gmotherstatus()
	{
	...
	const vector<bool> &V80_03::genbosons_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genbosons_p4()
	{
	...
	const vector<int> &V80_03::genbosons_id()
	{
	...
	const vector<int> &V80_03::genbosons__genpsidx()
	{
	...
	const vector<int> &V80_03::genbosons_status()
	{
	...
	const vector<bool> &V80_03::genbosons_fromHardProcessDecayed()
	{
	...
	const vector<bool> &V80_03::genbosons_fromHardProcessFinalState()
	{
	...
	const vector<bool> &V80_03::genbosons_isHardProcess()
	{
	...
	const vector<bool> &V80_03::genbosons_isLastCopy()
	{
	...
	const vector<int> &V80_03::genbosons_gentaudecay()
	{
	...
	const int &V80_03::gen_nfromtbosons_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genbosons_motherp4()
	{
	...
	const vector<int> &V80_03::genbosons_motherid()
	{
	...
	const vector<int> &V80_03::genbosons_motheridx()
	{
	...
	const vector<int> &V80_03::genbosons_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::genbosons_gmotherp4()
	{
	...
	const vector<int> &V80_03::genbosons_gmotherid()
	{
	...
	const vector<int> &V80_03::genbosons_gmotheridx()
	{
	...
	const vector<int> &V80_03::genbosons_gmotherstatus()
	{
	...
	const vector<bool> &V80_03::gensusy_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::gensusy_p4()
	{
	...
	const vector<int> &V80_03::gensusy_id()
	{
	...
	const vector<int> &V80_03::gensusy__genpsidx()
	{
	...
	const vector<int> &V80_03::gensusy_status()
	{
	...
	const vector<bool> &V80_03::gensusy_fromHardProcessDecayed()
	{
	...
	const vector<bool> &V80_03::gensusy_fromHardProcessFinalState()
	{
	...
	const vector<bool> &V80_03::gensusy_isHardProcess()
	{
	...
	const vector<bool> &V80_03::gensusy_isLastCopy()
	{
	...
	const vector<int> &V80_03::gensusy_gentaudecay()
	{
	...
	const int &V80_03::gen_nfromtsusy_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::gensusy_motherp4()
	{
	...
	const vector<int> &V80_03::gensusy_motherid()
	{
	...
	const vector<int> &V80_03::gensusy_motheridx()
	{
	...
	const vector<int> &V80_03::gensusy_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::gensusy_gmotherp4()
	{
	...
	const vector<int> &V80_03::gensusy_gmotherid()
	{
	...
	const vector<int> &V80_03::gensusy_gmotheridx()
	{
	...
	const vector<int> &V80_03::gensusy_gmotherstatus()
	{
	...
	const vector<TString> &V80_03::tau_IDnames()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::tau_leadtrack_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::tau_leadneutral_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::tau_p4()
	{
	...
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &V80_03::tau_isocand_p4()
	{
	...
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &V80_03::tau_sigcand_p4()
	{
	...
	const vector<vector<float> > &V80_03::tau_ID()
	{
	...
	const vector<float> &V80_03::tau_passID()
	{
	...
	const vector<float> &V80_03::tau_againstMuonTight()
	{
	...
	const vector<float> &V80_03::tau_againstElectronLoose()
	{
	...
	const vector<bool> &V80_03::tau_isVetoTau()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &V80_03::isoTracks_p4()
	{
	...
	const vector<int> &V80_03::isoTracks_charge()
	{
	...
	const vector<float> &V80_03::isoTracks_absIso()
	{
	...
	const vector<float> &V80_03::isoTracks_dz()
	{
	...
	const vector<int> &V80_03::isoTracks_pdgId()
	{
	...
	const int &V80_03::nhighPtPFcands()
	{
	...
	const vector<float> &V80_03::highPtPFcands_pt()
	{
	...
	const vector<float> &V80_03::highPtPFcands_eta()
	{
	...
	const vector<float> &V80_03::highPtPFcands_phi()
	{
	...
	const vector<float> &V80_03::highPtPFcands_mass()
	{
	...
	const vector<float> &V80_03::highPtPFcands_absIso()
	{
	...
	const vector<float> &V80_03::highPtPFcands_relIsoAn04()
	{
		if (not highPtPFcands_relIsoAn04_isLoaded) {
			if (highPtPFcands_relIsoAn04_branch != 0) {
				highPtPFcands_relIsoAn04_branch->GetEntry(index);
			} else { 
				printf("branch highPtPFcands_relIsoAn04_branch does not exist!\n");
				exit(1);
			}
			highPtPFcands_relIsoAn04_isLoaded = true;
		}
		return *highPtPFcands_relIsoAn04_;
	}
	const vector<float> &V80_03::highPtPFcands_dz()
	{
	...
	const vector<float> &V80_03::highPtPFcands_pdgId()
	{
	...
	const vector<float> &V80_03::highPtPFcands_mcMatchId()
	{
	...
	const vector<bool> &V80_03::isoTracks_isVetoTrack()
	{
	...
	const vector<bool> &V80_03::isoTracks_isVetoTrack_v2()
	{
	...
	const vector<bool> &V80_03::isoTracks_isVetoTrack_v3()
	{
  ...
  void V80_03::progress( int nEventsTotal, int nEventsChain ){
    int period = 1000;
...
namespace V80_03_np {
	const unsigned int &run() { return v80_03.run(); }
	const unsigned int &ls() { return v80_03.ls(); }
	const unsigned int &evt() { return v80_03.evt(); }
	const int &nvtxs() { return v80_03.nvtxs(); }
	const int &pu_nvtxs() { return v80_03.pu_nvtxs(); }
	const float &pfmet() { return v80_03.pfmet(); }
	const float &pfmet_phi() { return v80_03.pfmet_phi(); }
	const float &pfmet_jup() { return v80_03.pfmet_jup(); }
	const float &pfmet_phi_jup() { return v80_03.pfmet_phi_jup(); }
	const float &pfmet_jdown() { return v80_03.pfmet_jdown(); }
	const float &pfmet_phi_jdown() { return v80_03.pfmet_phi_jdown(); }
	const float &pfmet_rl() { return v80_03.pfmet_rl(); }
	const float &pfmet_phi_rl() { return v80_03.pfmet_phi_rl(); }
	const float &pfmet_rl_jup() { return v80_03.pfmet_rl_jup(); }
	const float &pfmet_phi_rl_jup() { return v80_03.pfmet_phi_rl_jup(); }
	const float &pfmet_rl_jdown() { return v80_03.pfmet_rl_jdown(); }
	const float &pfmet_phi_rl_jdown() { return v80_03.pfmet_phi_rl_jdown(); }
	const float &scale1fb() { return v80_03.scale1fb(); }
	const float &xsec() { return v80_03.xsec(); }
	const float &xsec_uncert() { return v80_03.xsec_uncert(); }
	const float &kfactor() { return v80_03.kfactor(); }
	const float &pu_ntrue() { return v80_03.pu_ntrue(); }
	const int &ngoodleps() { return v80_03.ngoodleps(); }
	const int &nlooseleps() { return v80_03.nlooseleps(); }
	const int &nvetoleps() { return v80_03.nvetoleps(); }
	const bool &is_data() { return v80_03.is_data(); }
	const string &dataset() { return v80_03.dataset(); }
	const string &filename() { return v80_03.filename(); }
	const bool &filt_badmuons() { return v80_03.filt_badmuons(); }
	const bool &filt_duplicatemuons() { return v80_03.filt_duplicatemuons(); }
	const bool &filt_nobadmuons() { return v80_03.filt_nobadmuons(); }
	const string &cms3tag() { return v80_03.cms3tag(); }
	const unsigned int &nEvents() { return v80_03.nEvents(); }
	const unsigned int &nEvents_goodvtx() { return v80_03.nEvents_goodvtx(); }
	const unsigned int &nEvents_MET30() { return v80_03.nEvents_MET30(); }
	const unsigned int &nEvents_1goodlep() { return v80_03.nEvents_1goodlep(); }
	const unsigned int &nEvents_2goodjets() { return v80_03.nEvents_2goodjets(); }
	const int &is0lep() { return v80_03.is0lep(); }
	const int &is1lep() { return v80_03.is1lep(); }
	const int &is2lep() { return v80_03.is2lep(); }
	const int &isZtoNuNu() { return v80_03.isZtoNuNu(); }
	const int &is1lepFromW() { return v80_03.is1lepFromW(); }
	const int &is1lepFromTop() { return v80_03.is1lepFromTop(); }
	const float &mbb() { return v80_03.mbb(); }
	const float &mbb_jup() { return v80_03.mbb_jup(); }
	const float &mbb_jdown() { return v80_03.mbb_jdown(); }
	const float &mct() { return v80_03.mct(); }
	const float &mct_jup() { return v80_03.mct_jup(); }
	const float &mct_jdown() { return v80_03.mct_jdown(); }
	const float &MT2W() { return v80_03.MT2W(); }
	const float &MT2W_rl() { return v80_03.MT2W_rl(); }
	const float &mindphi_met_j1_j2() { return v80_03.mindphi_met_j1_j2(); }
	const float &mindphi_met_j1_j2_rl() { return v80_03.mindphi_met_j1_j2_rl(); }
	const float &mt_met_lep() { return v80_03.mt_met_lep(); }
	const float &mt_met_lep_rl() { return v80_03.mt_met_lep_rl(); }
	const float &MT2W_jup() { return v80_03.MT2W_jup(); }
	const float &MT2W_rl_jup() { return v80_03.MT2W_rl_jup(); }
	const float &mindphi_met_j1_j2_jup() { return v80_03.mindphi_met_j1_j2_jup(); }
	const float &mindphi_met_j1_j2_rl_jup() { return v80_03.mindphi_met_j1_j2_rl_jup(); }
	const float &mt_met_lep_jup() { return v80_03.mt_met_lep_jup(); }
	const float &mt_met_lep_rl_jup() { return v80_03.mt_met_lep_rl_jup(); }
	const float &MT2W_jdown() { return v80_03.MT2W_jdown(); }
	const float &MT2W_rl_jdown() { return v80_03.MT2W_rl_jdown(); }
	const float &mindphi_met_j1_j2_jdown() { return v80_03.mindphi_met_j1_j2_jdown(); }
	const float &mindphi_met_j1_j2_rl_jdown() { return v80_03.mindphi_met_j1_j2_rl_jdown(); }
	const float &mt_met_lep_jdown() { return v80_03.mt_met_lep_jdown(); }
	const float &mt_met_lep_rl_jdown() { return v80_03.mt_met_lep_rl_jdown(); }
	const float &hadronic_top_chi2() { return v80_03.hadronic_top_chi2(); }
	const float &ak4pfjets_rho() { return v80_03.ak4pfjets_rho(); }
	const float &pdf_up_weight() { return v80_03.pdf_up_weight(); }
	const float &pdf_down_weight() { return v80_03.pdf_down_weight(); }
	const vector<string> &genweightsID() { return v80_03.genweightsID(); }
	const vector<float> &genweights() { return v80_03.genweights(); }
	const float &weight_btagsf() { return v80_03.weight_btagsf(); }
	const float &weight_btagsf_heavy_UP() { return v80_03.weight_btagsf_heavy_UP(); }
	const float &weight_btagsf_light_UP() { return v80_03.weight_btagsf_light_UP(); }
	const float &weight_btagsf_heavy_DN() { return v80_03.weight_btagsf_heavy_DN(); }
	const float &weight_btagsf_light_DN() { return v80_03.weight_btagsf_light_DN(); }
	const float &weight_btagsf_fastsim_UP() { return v80_03.weight_btagsf_fastsim_UP(); }
	const float &weight_btagsf_fastsim_DN() { return v80_03.weight_btagsf_fastsim_DN(); }
	const float &weight_lepSF() { return v80_03.weight_lepSF(); }
	const float &weight_lepSF_up() { return v80_03.weight_lepSF_up(); }
	const float &weight_lepSF_down() { return v80_03.weight_lepSF_down(); }
	const float &weight_vetoLepSF() { return v80_03.weight_vetoLepSF(); }
	const float &weight_vetoLepSF_up() { return v80_03.weight_vetoLepSF_up(); }
	const float &weight_vetoLepSF_down() { return v80_03.weight_vetoLepSF_down(); }
	const float &weight_lepSF_fastSim() { return v80_03.weight_lepSF_fastSim(); }
	const float &weight_lepSF_fastSim_up() { return v80_03.weight_lepSF_fastSim_up(); }
	const float &weight_lepSF_fastSim_down() { return v80_03.weight_lepSF_fastSim_down(); }
	const float &weight_ISR() { return v80_03.weight_ISR(); }
	const float &weight_ISRup() { return v80_03.weight_ISRup(); }
	const float &weight_ISRdown() { return v80_03.weight_ISRdown(); }
	const float &weight_PU() { return v80_03.weight_PU(); }
	const float &weight_PUup() { return v80_03.weight_PUup(); }
	const float &weight_PUdown() { return v80_03.weight_PUdown(); }
	const float &weight_ISRnjets() { return v80_03.weight_ISRnjets(); }
	const float &weight_ISRnjets_UP() { return v80_03.weight_ISRnjets_UP(); }
	const float &weight_ISRnjets_DN() { return v80_03.weight_ISRnjets_DN(); }
	const int &NISRjets() { return v80_03.NISRjets(); }
	const int &NnonISRjets() { return v80_03.NnonISRjets(); }
	const bool &filt_fastsimjets() { return v80_03.filt_fastsimjets(); }
	const bool &filt_fastsimjets_jup() { return v80_03.filt_fastsimjets_jup(); }
	const bool &filt_fastsimjets_jdown() { return v80_03.filt_fastsimjets_jdown(); }
	const bool &filt_jetWithBadMuon() { return v80_03.filt_jetWithBadMuon(); }
	const bool &filt_jetWithBadMuon_jup() { return v80_03.filt_jetWithBadMuon_jup(); }
	const bool &filt_jetWithBadMuon_jdown() { return v80_03.filt_jetWithBadMuon_jdown(); }
	const bool &filt_pfovercalomet() { return v80_03.filt_pfovercalomet(); }
	const vector<string> &sparms_names() { return v80_03.sparms_names(); }
	const vector<float> &sparms_values() { return v80_03.sparms_values(); }
	const int &sparms_subProcessId() { return v80_03.sparms_subProcessId(); }
	const float &mass_lsp() { return v80_03.mass_lsp(); }
	const float &mass_chargino() { return v80_03.mass_chargino(); }
	const float &mass_stop() { return v80_03.mass_stop(); }
	const float &mass_gluino() { return v80_03.mass_gluino(); }
	const float &genmet() { return v80_03.genmet(); }
	const float &genmet_phi() { return v80_03.genmet_phi(); }
	const float &nupt() { return v80_03.nupt(); }
	const float &genht() { return v80_03.genht(); }
	const bool &PassTrackVeto() { return v80_03.PassTrackVeto(); }
	const bool &PassTauVeto() { return v80_03.PassTauVeto(); }
	const float &topness() { return v80_03.topness(); }
	const float &topnessMod() { return v80_03.topnessMod(); }
	const float &topnessMod_rl() { return v80_03.topnessMod_rl(); }
	const float &topnessMod_jup() { return v80_03.topnessMod_jup(); }
	const float &topnessMod_rl_jup() { return v80_03.topnessMod_rl_jup(); }
	const float &topnessMod_jdown() { return v80_03.topnessMod_jdown(); }
	const float &topnessMod_rl_jdown() { return v80_03.topnessMod_rl_jdown(); }
	const float &Mlb_closestb() { return v80_03.Mlb_closestb(); }
	const int &HLT_SingleEl() { return v80_03.HLT_SingleEl(); }
	const int &HLT_SingleMu() { return v80_03.HLT_SingleMu(); }
	const int &HLT_SingleMuNoIso() { return v80_03.HLT_SingleMuNoIso(); }
	const int &HLT_SingleElNoIso() { return v80_03.HLT_SingleElNoIso(); }
	const int &HLT_MET() { return v80_03.HLT_MET(); }
	const int &HLT_MET100_MHT100() { return v80_03.HLT_MET100_MHT100(); }
	const int &HLT_DiEl() { return v80_03.HLT_DiEl(); }
	const int &HLT_DiMu() { return v80_03.HLT_DiMu(); }
	const int &HLT_MuE() { return v80_03.HLT_MuE(); }
	const int &HLT_Photon90_CaloIdL_PFHT500() { return v80_03.HLT_Photon90_CaloIdL_PFHT500(); }
	const int &HLT_Photon22_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon22_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon30_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon30_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon36_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon36_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon50_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon50_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon75_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon75_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon90_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon90_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon120_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon120_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon165_R9Id90_HE10_IsoM() { return v80_03.HLT_Photon165_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon175() { return v80_03.HLT_Photon175(); }
	const int &HLT_Photon165_HE10() { return v80_03.HLT_Photon165_HE10(); }
	const int &nPhotons() { return v80_03.nPhotons(); }
	const int &ph_ngoodjets() { return v80_03.ph_ngoodjets(); }
	const int &ph_ngoodbtags() { return v80_03.ph_ngoodbtags(); }
	const float &filt_met() { return v80_03.filt_met(); }
	const float &filt_badMuonFilter() { return v80_03.filt_badMuonFilter(); }
	const float &filt_badChargedCandidateFilter() { return v80_03.filt_badChargedCandidateFilter(); }
	const float &filt_cscbeamhalo2015() { return v80_03.filt_cscbeamhalo2015(); }
	const float &filt_cscbeamhalo() { return v80_03.filt_cscbeamhalo(); }
	const float &hardgenpt() { return v80_03.hardgenpt(); }
	const float &calomet() { return v80_03.calomet(); }
	const float &calomet_phi() { return v80_03.calomet_phi(); }
	const int &lep1_pdgid() { return v80_03.lep1_pdgid(); }
	const int &lep1_production_type() { return v80_03.lep1_production_type(); }
	const float &lep1_MiniIso() { return v80_03.lep1_MiniIso(); }
	const float &lep1_relIso() { return v80_03.lep1_relIso(); }
	const float &lep1_gfit_ptErr() { return v80_03.lep1_gfit_ptErr(); }
	const float &lep1_gfit_pt() { return v80_03.lep1_gfit_pt(); }
	const bool &lep1_passLooseID() { return v80_03.lep1_passLooseID(); }
	const bool &lep1_passMediumID() { return v80_03.lep1_passMediumID(); }
	const bool &lep1_passTightID() { return v80_03.lep1_passTightID(); }
	const bool &lep1_passVeto() { return v80_03.lep1_passVeto(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep1_p4() { return v80_03.lep1_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep1_mcp4() { return v80_03.lep1_mcp4(); }
	const int &lep1_mc_motherid() { return v80_03.lep1_mc_motherid(); }
	const int &lep2_pdgid() { return v80_03.lep2_pdgid(); }
	const int &lep2_production_type() { return v80_03.lep2_production_type(); }
	const float &lep2_MiniIso() { return v80_03.lep2_MiniIso(); }
	const float &lep2_relIso() { return v80_03.lep2_relIso(); }
	const float &lep2_gfit_ptErr() { return v80_03.lep2_gfit_ptErr(); }
	const float &lep2_gfit_pt() { return v80_03.lep2_gfit_pt(); }
	const bool &lep2_passLooseID() { return v80_03.lep2_passLooseID(); }
	const bool &lep2_passMediumID() { return v80_03.lep2_passMediumID(); }
	const bool &lep2_passTightID() { return v80_03.lep2_passTightID(); }
	const bool &lep2_passVeto() { return v80_03.lep2_passVeto(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep2_p4() { return v80_03.lep2_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep2_mcp4() { return v80_03.lep2_mcp4(); }
	const int &lep2_mc_motherid() { return v80_03.lep2_mc_motherid(); }
	const vector<float> &ph_sigmaIEtaEta_fill5x5() { return v80_03.ph_sigmaIEtaEta_fill5x5(); }
	const vector<float> &ph_hOverE() { return v80_03.ph_hOverE(); }
	const vector<float> &ph_r9() { return v80_03.ph_r9(); }
	const vector<float> &ph_chiso() { return v80_03.ph_chiso(); }
	const vector<float> &ph_nhiso() { return v80_03.ph_nhiso(); }
	const vector<float> &ph_phiso() { return v80_03.ph_phiso(); }
	const vector<bool> &ph_idCutBased() { return v80_03.ph_idCutBased(); }
	const vector<int> &ph_overlapJetId() { return v80_03.ph_overlapJetId(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ph_p4() { return v80_03.ph_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ph_mcp4() { return v80_03.ph_mcp4(); }
	const vector<float> &ph_pt() { return v80_03.ph_pt(); }
	const vector<float> &ph_eta() { return v80_03.ph_eta(); }
	const vector<float> &ph_phi() { return v80_03.ph_phi(); }
	const vector<float> &ph_mass() { return v80_03.ph_mass(); }
	const vector<int> &ph_mcMatchId() { return v80_03.ph_mcMatchId(); }
	const vector<float> &ph_genIso04() { return v80_03.ph_genIso04(); }
	const vector<float> &ph_drMinParton() { return v80_03.ph_drMinParton(); }
	const int &ngoodjets() { return v80_03.ngoodjets(); }
	const int &ngoodbtags() { return v80_03.ngoodbtags(); }
	const float &ak4_HT() { return v80_03.ak4_HT(); }
	const float &ak4_mbb() { return v80_03.ak4_mbb(); }
	const float &ak4_mct() { return v80_03.ak4_mct(); }
	const float &ak4_htratiom() { return v80_03.ak4_htratiom(); }
	const vector<float> &dphi_ak4pfjet_met() { return v80_03.dphi_ak4pfjet_met(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak4pfjets_p4() { return v80_03.ak4pfjets_p4(); }
	const vector<bool> &ak4pfjets_passMEDbtag() { return v80_03.ak4pfjets_passMEDbtag(); }
	const vector<float> &ak4pfjets_CSV() { return v80_03.ak4pfjets_CSV(); }
	const vector<float> &ak4pfjets_mva() { return v80_03.ak4pfjets_mva(); }
	const vector<int> &ak4pfjets_parton_flavor() { return v80_03.ak4pfjets_parton_flavor(); }
	const vector<int> &ak4pfjets_hadron_flavor() { return v80_03.ak4pfjets_hadron_flavor(); }
	const vector<bool> &ak4pfjets_loose_puid() { return v80_03.ak4pfjets_loose_puid(); }
	const vector<bool> &ak4pfjets_loose_pfid() { return v80_03.ak4pfjets_loose_pfid(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &ak4pfjets_leadMEDbjet_p4() { return v80_03.ak4pfjets_leadMEDbjet_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &ak4pfjets_leadbtag_p4() { return v80_03.ak4pfjets_leadbtag_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak4genjets_p4() { return v80_03.ak4genjets_p4(); }
	const int &jup_ngoodjets() { return v80_03.jup_ngoodjets(); }
	const int &jup_ngoodbtags() { return v80_03.jup_ngoodbtags(); }
	const float &jup_ak4_HT() { return v80_03.jup_ak4_HT(); }
	const float &jup_ak4_mbb() { return v80_03.jup_ak4_mbb(); }
	const float &jup_ak4_mct() { return v80_03.jup_ak4_mct(); }
	const float &jup_ak4_htratiom() { return v80_03.jup_ak4_htratiom(); }
	const vector<float> &jup_dphi_ak4pfjet_met() { return v80_03.jup_dphi_ak4pfjet_met(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak4pfjets_p4() { return v80_03.jup_ak4pfjets_p4(); }
	const vector<bool> &jup_ak4pfjets_passMEDbtag() { return v80_03.jup_ak4pfjets_passMEDbtag(); }
	const vector<float> &jup_ak4pfjets_CSV() { return v80_03.jup_ak4pfjets_CSV(); }
	const vector<float> &jup_ak4pfjets_mva() { return v80_03.jup_ak4pfjets_mva(); }
	const vector<int> &jup_ak4pfjets_parton_flavor() { return v80_03.jup_ak4pfjets_parton_flavor(); }
	const vector<int> &jup_ak4pfjets_hadron_flavor() { return v80_03.jup_ak4pfjets_hadron_flavor(); }
	const vector<bool> &jup_ak4pfjets_loose_puid() { return v80_03.jup_ak4pfjets_loose_puid(); }
	const vector<bool> &jup_ak4pfjets_loose_pfid() { return v80_03.jup_ak4pfjets_loose_pfid(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jup_ak4pfjets_leadMEDbjet_p4() { return v80_03.jup_ak4pfjets_leadMEDbjet_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jup_ak4pfjets_leadbtag_p4() { return v80_03.jup_ak4pfjets_leadbtag_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak4genjets_p4() { return v80_03.jup_ak4genjets_p4(); }
	const int &jdown_ngoodjets() { return v80_03.jdown_ngoodjets(); }
	const int &jdown_ngoodbtags() { return v80_03.jdown_ngoodbtags(); }
	const float &jdown_ak4_HT() { return v80_03.jdown_ak4_HT(); }
	const float &jdown_ak4_mbb() { return v80_03.jdown_ak4_mbb(); }
	const float &jdown_ak4_mct() { return v80_03.jdown_ak4_mct(); }
	const float &jdown_ak4_htratiom() { return v80_03.jdown_ak4_htratiom(); }
	const vector<float> &jdown_dphi_ak4pfjet_met() { return v80_03.jdown_dphi_ak4pfjet_met(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak4pfjets_p4() { return v80_03.jdown_ak4pfjets_p4(); }
	const vector<bool> &jdown_ak4pfjets_passMEDbtag() { return v80_03.jdown_ak4pfjets_passMEDbtag(); }
	const vector<float> &jdown_ak4pfjets_CSV() { return v80_03.jdown_ak4pfjets_CSV(); }
	const vector<float> &jdown_ak4pfjets_mva() { return v80_03.jdown_ak4pfjets_mva(); }
	const vector<int> &jdown_ak4pfjets_parton_flavor() { return v80_03.jdown_ak4pfjets_parton_flavor(); }
	const vector<int> &jdown_ak4pfjets_hadron_flavor() { return v80_03.jdown_ak4pfjets_hadron_flavor(); }
	const vector<bool> &jdown_ak4pfjets_loose_puid() { return v80_03.jdown_ak4pfjets_loose_puid(); }
	const vector<bool> &jdown_ak4pfjets_loose_pfid() { return v80_03.jdown_ak4pfjets_loose_pfid(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jdown_ak4pfjets_leadMEDbjet_p4() { return v80_03.jdown_ak4pfjets_leadMEDbjet_p4(); }
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jdown_ak4pfjets_leadbtag_p4() { return v80_03.jdown_ak4pfjets_leadbtag_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak4genjets_p4() { return v80_03.jdown_ak4genjets_p4(); }
	const vector<bool> &genleps_isfromt() { return v80_03.genleps_isfromt(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genleps_p4() { return v80_03.genleps_p4(); }
	const vector<int> &genleps_id() { return v80_03.genleps_id(); }
	const vector<int> &genleps__genpsidx() { return v80_03.genleps__genpsidx(); }
	const vector<int> &genleps_status() { return v80_03.genleps_status(); }
	const vector<bool> &genleps_fromHardProcessDecayed() { return v80_03.genleps_fromHardProcessDecayed(); }
	const vector<bool> &genleps_fromHardProcessFinalState() { return v80_03.genleps_fromHardProcessFinalState(); }
	const vector<bool> &genleps_isHardProcess() { return v80_03.genleps_isHardProcess(); }
	const vector<bool> &genleps_isLastCopy() { return v80_03.genleps_isLastCopy(); }
	const vector<int> &genleps_gentaudecay() { return v80_03.genleps_gentaudecay(); }
	const int &gen_nfromtleps_() { return v80_03.gen_nfromtleps_(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genleps_motherp4() { return v80_03.genleps_motherp4(); }
	const vector<int> &genleps_motherid() { return v80_03.genleps_motherid(); }
	const vector<int> &genleps_motheridx() { return v80_03.genleps_motheridx(); }
	const vector<int> &genleps_motherstatus() { return v80_03.genleps_motherstatus(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genleps_gmotherp4() { return v80_03.genleps_gmotherp4(); }
	const vector<int> &genleps_gmotherid() { return v80_03.genleps_gmotherid(); }
	const vector<int> &genleps_gmotheridx() { return v80_03.genleps_gmotheridx(); }
	const vector<int> &genleps_gmotherstatus() { return v80_03.genleps_gmotherstatus(); }
	const vector<bool> &gennus_isfromt() { return v80_03.gennus_isfromt(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gennus_p4() { return v80_03.gennus_p4(); }
	const vector<int> &gennus_id() { return v80_03.gennus_id(); }
	const vector<int> &gennus__genpsidx() { return v80_03.gennus__genpsidx(); }
	const vector<int> &gennus_status() { return v80_03.gennus_status(); }
	const vector<bool> &gennus_fromHardProcessDecayed() { return v80_03.gennus_fromHardProcessDecayed(); }
	const vector<bool> &gennus_fromHardProcessFinalState() { return v80_03.gennus_fromHardProcessFinalState(); }
	const vector<bool> &gennus_isHardProcess() { return v80_03.gennus_isHardProcess(); }
	const vector<bool> &gennus_isLastCopy() { return v80_03.gennus_isLastCopy(); }
	const vector<int> &gennus_gentaudecay() { return v80_03.gennus_gentaudecay(); }
	const int &gen_nfromtnus_() { return v80_03.gen_nfromtnus_(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gennus_motherp4() { return v80_03.gennus_motherp4(); }
	const vector<int> &gennus_motherid() { return v80_03.gennus_motherid(); }
	const vector<int> &gennus_motheridx() { return v80_03.gennus_motheridx(); }
	const vector<int> &gennus_motherstatus() { return v80_03.gennus_motherstatus(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gennus_gmotherp4() { return v80_03.gennus_gmotherp4(); }
	const vector<int> &gennus_gmotherid() { return v80_03.gennus_gmotherid(); }
	const vector<int> &gennus_gmotheridx() { return v80_03.gennus_gmotheridx(); }
	const vector<int> &gennus_gmotherstatus() { return v80_03.gennus_gmotherstatus(); }
	const vector<bool> &genqs_isfromt() { return v80_03.genqs_isfromt(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genqs_p4() { return v80_03.genqs_p4(); }
	const vector<int> &genqs_id() { return v80_03.genqs_id(); }
	const vector<int> &genqs__genpsidx() { return v80_03.genqs__genpsidx(); }
	const vector<int> &genqs_status() { return v80_03.genqs_status(); }
	const vector<bool> &genqs_fromHardProcessDecayed() { return v80_03.genqs_fromHardProcessDecayed(); }
	const vector<bool> &genqs_fromHardProcessFinalState() { return v80_03.genqs_fromHardProcessFinalState(); }
	const vector<bool> &genqs_isHardProcess() { return v80_03.genqs_isHardProcess(); }
	const vector<bool> &genqs_isLastCopy() { return v80_03.genqs_isLastCopy(); }
	const vector<int> &genqs_gentaudecay() { return v80_03.genqs_gentaudecay(); }
	const int &gen_nfromtqs_() { return v80_03.gen_nfromtqs_(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genqs_motherp4() { return v80_03.genqs_motherp4(); }
	const vector<int> &genqs_motherid() { return v80_03.genqs_motherid(); }
	const vector<int> &genqs_motheridx() { return v80_03.genqs_motheridx(); }
	const vector<int> &genqs_motherstatus() { return v80_03.genqs_motherstatus(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genqs_gmotherp4() { return v80_03.genqs_gmotherp4(); }
	const vector<int> &genqs_gmotherid() { return v80_03.genqs_gmotherid(); }
	const vector<int> &genqs_gmotheridx() { return v80_03.genqs_gmotheridx(); }
	const vector<int> &genqs_gmotherstatus() { return v80_03.genqs_gmotherstatus(); }
	const vector<bool> &genbosons_isfromt() { return v80_03.genbosons_isfromt(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genbosons_p4() { return v80_03.genbosons_p4(); }
	const vector<int> &genbosons_id() { return v80_03.genbosons_id(); }
	const vector<int> &genbosons__genpsidx() { return v80_03.genbosons__genpsidx(); }
	const vector<int> &genbosons_status() { return v80_03.genbosons_status(); }
	const vector<bool> &genbosons_fromHardProcessDecayed() { return v80_03.genbosons_fromHardProcessDecayed(); }
	const vector<bool> &genbosons_fromHardProcessFinalState() { return v80_03.genbosons_fromHardProcessFinalState(); }
	const vector<bool> &genbosons_isHardProcess() { return v80_03.genbosons_isHardProcess(); }
	const vector<bool> &genbosons_isLastCopy() { return v80_03.genbosons_isLastCopy(); }
	const vector<int> &genbosons_gentaudecay() { return v80_03.genbosons_gentaudecay(); }
	const int &gen_nfromtbosons_() { return v80_03.gen_nfromtbosons_(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genbosons_motherp4() { return v80_03.genbosons_motherp4(); }
	const vector<int> &genbosons_motherid() { return v80_03.genbosons_motherid(); }
	const vector<int> &genbosons_motheridx() { return v80_03.genbosons_motheridx(); }
	const vector<int> &genbosons_motherstatus() { return v80_03.genbosons_motherstatus(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genbosons_gmotherp4() { return v80_03.genbosons_gmotherp4(); }
	const vector<int> &genbosons_gmotherid() { return v80_03.genbosons_gmotherid(); }
	const vector<int> &genbosons_gmotheridx() { return v80_03.genbosons_gmotheridx(); }
	const vector<int> &genbosons_gmotherstatus() { return v80_03.genbosons_gmotherstatus(); }
	const vector<bool> &gensusy_isfromt() { return v80_03.gensusy_isfromt(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gensusy_p4() { return v80_03.gensusy_p4(); }
	const vector<int> &gensusy_id() { return v80_03.gensusy_id(); }
	const vector<int> &gensusy__genpsidx() { return v80_03.gensusy__genpsidx(); }
	const vector<int> &gensusy_status() { return v80_03.gensusy_status(); }
	const vector<bool> &gensusy_fromHardProcessDecayed() { return v80_03.gensusy_fromHardProcessDecayed(); }
	const vector<bool> &gensusy_fromHardProcessFinalState() { return v80_03.gensusy_fromHardProcessFinalState(); }
	const vector<bool> &gensusy_isHardProcess() { return v80_03.gensusy_isHardProcess(); }
	const vector<bool> &gensusy_isLastCopy() { return v80_03.gensusy_isLastCopy(); }
	const vector<int> &gensusy_gentaudecay() { return v80_03.gensusy_gentaudecay(); }
	const int &gen_nfromtsusy_() { return v80_03.gen_nfromtsusy_(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gensusy_motherp4() { return v80_03.gensusy_motherp4(); }
	const vector<int> &gensusy_motherid() { return v80_03.gensusy_motherid(); }
	const vector<int> &gensusy_motheridx() { return v80_03.gensusy_motheridx(); }
	const vector<int> &gensusy_motherstatus() { return v80_03.gensusy_motherstatus(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &gensusy_gmotherp4() { return v80_03.gensusy_gmotherp4(); }
	const vector<int> &gensusy_gmotherid() { return v80_03.gensusy_gmotherid(); }
	const vector<int> &gensusy_gmotheridx() { return v80_03.gensusy_gmotheridx(); }
	const vector<int> &gensusy_gmotherstatus() { return v80_03.gensusy_gmotherstatus(); }
	const vector<TString> &tau_IDnames() { return v80_03.tau_IDnames(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tau_leadtrack_p4() { return v80_03.tau_leadtrack_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tau_leadneutral_p4() { return v80_03.tau_leadneutral_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tau_p4() { return v80_03.tau_p4(); }
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &tau_isocand_p4() { return v80_03.tau_isocand_p4(); }
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &tau_sigcand_p4() { return v80_03.tau_sigcand_p4(); }
	const vector<vector<float> > &tau_ID() { return v80_03.tau_ID(); }
	const vector<float> &tau_passID() { return v80_03.tau_passID(); }
	const int &ngoodtaus() { return v80_03.ngoodtaus(); }
	const vector<float> &tau_againstMuonTight() { return v80_03.tau_againstMuonTight(); }
	const vector<float> &tau_againstElectronLoose() { return v80_03.tau_againstElectronLoose(); }
	const vector<bool> &tau_isVetoTau() { return v80_03.tau_isVetoTau(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &isoTracks_p4() { return v80_03.isoTracks_p4(); }
	const vector<int> &isoTracks_charge() { return v80_03.isoTracks_charge(); }
	const vector<float> &isoTracks_absIso() { return v80_03.isoTracks_absIso(); }
	const vector<float> &isoTracks_dz() { return v80_03.isoTracks_dz(); }
	const vector<int> &isoTracks_pdgId() { return v80_03.isoTracks_pdgId(); }
	const int &nhighPtPFcands() { return v80_03.nhighPtPFcands(); }
	const vector<float> &highPtPFcands_pt() { return v80_03.highPtPFcands_pt(); }
	const vector<float> &highPtPFcands_eta() { return v80_03.highPtPFcands_eta(); }
	const vector<float> &highPtPFcands_phi() { return v80_03.highPtPFcands_phi(); }
	const vector<float> &highPtPFcands_mass() { return v80_03.highPtPFcands_mass(); }
	const vector<float> &highPtPFcands_absIso() { return v80_03.highPtPFcands_absIso(); }
	const vector<float> &highPtPFcands_relIsoAn04() { return v80_03.highPtPFcands_relIsoAn04(); }
	const vector<float> &highPtPFcands_dz() { return v80_03.highPtPFcands_dz(); }
	const vector<float> &highPtPFcands_pdgId() { return v80_03.highPtPFcands_pdgId(); }
	const vector<float> &highPtPFcands_mcMatchId() { return v80_03.highPtPFcands_mcMatchId(); }
	const vector<bool> &isoTracks_isVetoTrack() { return v80_03.isoTracks_isVetoTrack(); }
	const vector<bool> &isoTracks_isVetoTrack_v2() { return v80_03.isoTracks_isVetoTrack_v2(); }
	const vector<bool> &isoTracks_isVetoTrack_v3() { return v80_03.isoTracks_isVetoTrack_v3(); }
}
