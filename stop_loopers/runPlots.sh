...
root -b -q "drawDatavsMC.cc+( \"$analysis_version\", $lumi, \"_inclusive\", \"el\", \"ht\",       \"njet2_met100\" )" 
...
root -b -q "drawDatavsMC.cc+( \"$analysis_version\", $lumi, \"_inclusive\", \"el_ec\", \"mt\",       \"njet2_met100\" )" 
