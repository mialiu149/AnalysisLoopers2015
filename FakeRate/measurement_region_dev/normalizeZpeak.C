...
//	  TString dyf = "/nfs-7/userdata/leptonTree/"+tag+"/DY_madgraph*.root";
  ...
  TString dataf = (doMu ? "/nfs-7/userdata/phchang/lepton_babies/v4.0/2016SingleMu*.root" : "/nfs-7/userdata/phchang/lepton_babies/v4.0/2016SingleEl*.root");
  TString dyf = "/nfs-7/userdata/phchang/lepton_babies/v4.0/DY_madgraph*.root";
  ...
  t_data->Draw("dilep_mass>>mll_data",Form("%f*%s*(abs(id)==%i && passes_VVV_cutbased_tight && %s>0 && tag_p4.pt()>30. && p4.pt()>25.)",mult,"1",idlep,hlt.Data()),"goff");
//	  t_data->Draw("dilep_mass>>mll_data",Form("%f*%s*(abs(id)==%i && passes_SS_tight_v5 && %s>0 && tag_p4.pt()>30. && p4.pt()>25.)",mult,"1",idlep,hlt.Data()),"goff");
  ...
  t_dy->Draw("dilep_mass>>mll_dy",Form("%f*scale1fb*%s*(abs(id)==%i && passes_VVV_cutbased_tight && %s>0 && tag_p4.pt()>30. && p4.pt()>25.)",intlumi,hlt.Data(),idlep,hlt.Data()),"goff");
