...
void plotEWKCorFR(float elSF_zp,float muSF_zp,float elSF_mt, float muSF_mt, bool useIsoTrig) {
...
//	  TFile *_file_dy = TFile::Open("rate_histos_dy_LooseEMVA"+suffix+".root");
  ...
  TFile *_file_data = TFile::Open("rate_histos_data.root");
  TFile *_file_wj = TFile::Open("rate_histos_wj.root");
  TFile *_file_dy = TFile::Open("rate_histos_dy.root");
