{
  ...
  gROOT->ProcessLine(".L ../../classFiles/triboson_v3/triboson.cc+");
  ...
  if(doData) {
    ...
    if (doLooseEMVA){
    //ch->Add("/nfs-7/userdata/namin/tupler_babies/merged/SS/v9.04/output/WJets*To*.root");
    //ch->Add("/home/users/namin/2016/ss/master/SSAnalysis/inSituFR/skims_Jan25/TTBAR_PH_skim.root");
     ch->Add("/nfs-7/userdata/bhashemi/WWW_babies/WWW_v0.1.6/skim/ttbar_*mgmlm*_ext1_*");
     ch->Add("/nfs-7/userdata/bhashemi/WWW_babies/WWW_v0.1.6/skim/wjets_incl_mgmlm_*.root");  
    }
