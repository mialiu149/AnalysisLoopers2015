...
row_inputs = [
              ...
              {'file':'lostlep_'+selection+'_hists.root','row_label':"Lost lepton",'hist_name':hist_prefix,'sys':0.3},
              {'file':'truess_'+selection+'_hists.root','row_label':'Same sign','hist_name':hist_prefix,'sys':0.5},
              {'file':'fakerate_'+selection+'_fakerate_hists.root','row_label':'Jet fake','hist_name':hist_prefix.replace('lep','lep'),'sys':0.1},
              {'file':'gammafake_'+selection+'_hists.root','row_label':'\gamma fake','hist_name':hist_prefix.replace('lep','lep'),'sys':0.52},
