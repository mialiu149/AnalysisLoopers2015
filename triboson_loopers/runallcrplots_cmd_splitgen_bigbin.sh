...
selection=$1
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"bkgtype\",\"$selection\" ,$sigscaleup,1,1,6,$setlog,$usedata,$usesig)" 
...
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptl1\",\"$selection\",$sigscaleup,20,10,250,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptl2\",\"$selection\",$sigscaleup,20,10,250,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptj1\",\"$selection\",$sigscaleup,20,10,250,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptj2\",\"$selection\",$sigscaleup,20,10,250,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptjj\",\"$selection\",$sigscaleup,20,10,250,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"met\",\"$selection\",$sigscaleup,40,0,140,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptll\",\"$selection\",$sigscaleup,40,10,490,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptlll\",\"$selection\",$sigscaleup,40,10,490,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"mlll\",\"$selection\",$sigscaleup,40,10,490,$setlog,$usedata,$usesig)" 
...
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"mll\",\"$selection\" ,$sigscaleup,40,0,180,$setlog,$usedata,$usesig)" 
...
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"mjj_lead\",\"$selection\" ,$sigscaleup,40,0,240,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"MCT\",\"$selection\" ,$sigscaleup,25,0,500,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"ptlljj\",\"$selection\" ,$sigscaleup,25,0,500,$setlog,$usedata,$usesig)" 
...
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"mtMax\",\"$selection\" ,$sigscaleup,25,0,250,$setlog,$usedata,$usesig)" 
...
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"mindphi_met_j1_j2\",\"$selection\" ,$sigscaleup,50,0,5,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"etal1\",\"$selection\" ,$sigscaleup,200,-5,5,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"etal2\",\"$selection\" ,$sigscaleup,200,-5,5,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"etaj1\",\"$selection\" ,$sigscaleup,200,-5,5,$setlog,$usedata,$usesig)" 
root -b -q "drawBkgvsSigSplitbyGen.cc+( \"$analysis_version\", $lumi, \"$selection\", \"lep\", \"etaj2\",\"$selection\" ,$sigscaleup,200,-5,5,$setlog,$usedata,$usesig)" 
