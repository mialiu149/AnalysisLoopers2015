...
float qcdMCFakeRateWWW(int id, float pt, float eta, float ht, TString version = "default") { 
    if (abs(id)==11) {
        ...
        else if(version.Contains("default")) { cout<<"correct"<<endl; return electronFakeRate_qcd_WWW(pt,eta); }
        ...
        else if(version.Contains("default")) return muonFakeRate_qcd_WWW(pt,eta);
