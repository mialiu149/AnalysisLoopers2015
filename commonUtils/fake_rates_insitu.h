float elecFakeRateInSituAllHT(float pt, float eta) {
   ...
   if (pt>=50 && pt<70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.155361;
   if (pt>=50 && pt<70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.211749;
   if (pt>=50 && pt<70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.336283;
   if (pt>=70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.311377;
   if (pt>=70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.350778;
   if (pt>=70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.488152;
   return 0.;
}
float elecFakeRateInSituErrorAllHT(float pt, float eta) {
   ...
   if (pt>=50 && pt<70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.0119821;
   if (pt>=50 && pt<70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.0151004;
   if (pt>=50 && pt<70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.0256593;
   if (pt>=70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.0146285;
   if (pt>=70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.0179475;
   if (pt>=70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.0243328;
   return 0.;
}
...
float elecFakeRateInSitu(float pt, float eta) {
   ...
   if (pt>=50 && pt<70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.175676;
   if (pt>=50 && pt<70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.2277;
   if (pt>=50 && pt<70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.410377;
   if (pt>=70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.336667;
   if (pt>=70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.387097;
   if (pt>=70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.515873;
   return 0.;
}
float elecFakeRateInSituError(float pt, float eta) {
   ...
   if (pt>=50 && pt<70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.0167201;
   if (pt>=50 && pt<70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.0203175;
   if (pt>=50 && pt<70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.033784;
   if (pt>=70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.0272838;
   if (pt>=70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.03093;
   if (pt>=70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.0445211;
   return 0.;
}
...
float elecFakeRateInSituHighHT(float pt, float eta) {
   ...
   if (pt>=50 && pt<70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.128788;
   if (pt>=50 && pt<70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.189542;
   if (pt>=50 && pt<70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.212598;
   if (pt>=70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.30057;
   if (pt>=70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.331155;
   if (pt>=70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.476351;
   return 0.;
}
float elecFakeRateInSituErrorHighHT(float pt, float eta) {
   ...
   if (pt>=50 && pt<70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.0168326;
   if (pt>=50 && pt<70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.0224057;
   if (pt>=50 && pt<70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.0363058;
   if (pt>=70 && fabs(eta)>=0 && fabs(eta)<0.8 ) return 0.0173052;
   if (pt>=70 && fabs(eta)>=0.8 && fabs(eta)<1.479 ) return 0.0219671;
   if (pt>=70 && fabs(eta)>=1.479 && fabs(eta)<2.5 ) return 0.0290294;
   return 0.;
}
