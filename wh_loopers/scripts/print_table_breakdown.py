...
#              {'file':'wjets_htbin_'+selection+'_hists.root','row_label':'w+jets','hist_name':hist_prefix},
              {'file':'ttw_'+selection+'_hists.root','row_label':'ttw','hist_name':hist_prefix},
              {'file':'tZq_'+selection+'_hists.root','row_label':'tZq','hist_name':hist_prefix},
              {'file':'WW_'+selection+'_hists.root','row_label':'WW','hist_name':hist_prefix},
              {'file':'WZ_'+selection+'_hists.root','row_label':'WZ','hist_name':hist_prefix},
              {'file':'ZZ_'+selection+'_hists.root','row_label':'ZZ','hist_name':hist_prefix}
             ]
##table to print out####
