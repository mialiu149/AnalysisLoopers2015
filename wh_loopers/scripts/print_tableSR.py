...
title = '1l CR & \\\\\n'
hist_prefix = 'h_lep_event_NEventsSRMultiBinV5_'+selection
...
row_inputs = [
              ...
              {'file':'wsLF_'+selection+'_hists.root','row_label':'w+bb','hist_name':hist_prefix.replace('lep','lep_HF')},
              ...
              {'file':'wsLF_'+selection+'_hists.root','row_label':'w+jets(light)','hist_name':hist_prefix.replace('lep','lep_LF')},
