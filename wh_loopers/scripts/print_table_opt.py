...
lumi = 10
selection="SR_yield_newbin_2btags_2jets_mbb100_mct190"
table_header = '\\begin{tabular}{lccccccccccc}\n'
title = 'SR & & Mt $>$ 100 & & & Mt $>$ 120 & & &Mt $>$ 150 & & &\\\\\n'
...
##cols to print out
label_col = ['Sample','MET[50,100]','MET[100,200]', 'MET[200,inf]',
              'MET[50,100]','MET[100,200]', 'MET[200,inf]',
              'MET[50,100]','MET[100,200]', 'MET[200,inf]']
