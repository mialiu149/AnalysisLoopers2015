...
void runTemplateLooper( std::string selection = "", std::string iter = "", std::string sample = "All_MC" ){
  ...
  string babylocation = "/nfs-6/userdata/mliu/onelepbabies/V80_4fb/";
  //string babylocation="/nfs-6/userdata/mliu/whbabies_btagfix/";
  //string stopbabylocation = "/nfs-7/userdata/mliu/onelepbabies/";
  //string stopbabylocation = "/nfs-7/userdata/mliu/onelepbabies/80x_0617/"; 
  string stopbabylocation = "/nfs-7/userdata/mliu/onelepbabies/80x_0617/";
  string datalocation="/nfs-6/userdata/mliu/onelepbabies/V80_4fb/"; 
  //string stopbabylocation="/hadoop/cms/store/user/isuarez/condor/stop_1l_babies/stop_babies__CMS3_V080005__BabyMaker_V0800X_v1__20160617/merged_files/"; 
